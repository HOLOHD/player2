...
angular
      ...
      function (e, a, t, s) {
        s.interceptors.push("onlineStatusInterceptor"),
          ...
          e
            ...
            .state("welcome", {
              url: "/welcome",
              templateUrl: "/app/partials/welcome/_welcome.html",
              controller: "AssetsCtrl",
            })
            .state("catagories", {
              url: "/catagories",
              templateUrl: "/app/partials/catagories/_catagories.html",
              controller: "AssetsCtrl",
            })
            .state("cat-a", {
              url: "/cat-a",
              templateUrl: "/app/partials/cat-a/_cat-a.html",
              controller: "AssetsCtrl",
            })
            .state("cat-b", {
              url: "/cat-b",
              templateUrl: "/app/partials/cat-b/_cat-b.html",
              controller: "AssetsCtrl",
            })
            .state("cat-c", {
              url: "/cat-c",
              templateUrl: "/app/partials/cat-c/_cat-c.html",
              controller: "AssetsCtrl",
            })
            .state("cat-d", {
              url: "/cat-d",
              templateUrl: "/app/partials/cat-d/_cat-d.html",
              controller: "AssetsCtrl",
            })
            .state("cat-e", {
              url: "/cat-e",
              templateUrl: "/app/partials/cat-e/_cat-e.html",
              controller: "AssetsCtrl",
            })
            .state("cat-f", {
              url: "/cat-f",
              templateUrl: "/app/partials/cat-e/_cat-f.html",
              controller: "AssetsCtrl",
            })
            .state("cat-g", {
              url: "/cat-g",
              templateUrl: "/app/partials/cat-e/_cat-g.html",
              controller: "AssetsCtrl",
            })
            .state("cat-h", {
              url: "/cat-h",
              templateUrl: "/app/partials/cat-h/_cat-h.html",
              controller: "AssetsCtrl",
            })
            .state("assets_edit", {
              url: "/assets/edit",
  ...
  angular
    ...
    .controller("NavbarCtrl", [
      ...
      function (s, e, a, t, l, n, i, o) {
        ...
        (s.goBack = function () {
          ...
          (s.doSearch = function () {
            (s.showSearchField = !s.showSearchField),
              s.showSearchField || (s.search = null);
          }),
          ...
          a.get(o.getStatus, {}).then(
            function (e) {
              e = e.data;
              s.cpuSerialNumber =
                e.data.cpuSerialNumber.slice(0, 4) +
                "-" +
                e.data.cpuSerialNumber.slice(4, 8) +
                "-" +
                e.data.cpuSerialNumber.slice(8, 12) +
                "-" +
                e.data.cpuSerialNumber.slice(12, 16);
            },
            function (e) {}
          );
      },
      ...
      function (t, a, e, s, l, n, i, o) {
        ...
        n.setCurrentLanguage("en"),
          ...
          (t.stop = function () {
            (t.operationInProgress = !0),
              a
                .post(l.play + (t.currentPlaylist || "default"), {
                  stop: !0,
                })
                .then(
                  function (e) {
          ...
          (t.downloadLog = function (e) {
            (t.statusMessage = o("Request sent , Please wait... ")),
              a
                .get(l.settings + "log?file=" + (e = e || "forever_out.log"), {
                  responseType: "blob",
                })
                .then(
                  function (e) {
                    ...
                    a && !1 === a.success
                      ...
                      : ((t.statusMessage = o("Saving the file")),
                        (a = new Blob([a], {
                          type: "text/plain",
                        })),
                        (e = e.headers("content-disposition")),
                        saveAs(a, e));
                  },
                  function (e) {
                    t.statusMessage =
                      o("Error in Downloading log files, ") + e.status;
                  }
                );
          }),
          (t.shellPopup = function () {
            (t.msg = {
                ...
                (t.msg.err = o("Please wait...")),
                  ...
                  a
                    ...
                    .then(
                      function (e) {
                        e = e.data;
                        (t.msg.err = e.data.err),
                          (t.msg.stderr = e.data.stderr),
                          (t.msg.stdout = e.data.stdout);
                      },
                      function (e) {}
                    );
              }),
              ...
              (t.getOldEntry = function (e) {
                38 == e.keyCode
                  ? (t.msg.cmd = s.previous())
                  : 40 == e.keyCode && (t.msg.cmd = s.next());
              }),
    ...
    .controller("SettingsCtrl", [
      ...
      "$window",
      "COUNTRIES",
      function (t, e, a, s, l, n, i, o, r, d, pi, m, u) {
        (t.countries = u),
          (t.settings = {
            localName: "",
            note: "",
            ...
            function (e) {
              ...
              e.success &&
                ...
                (t.settings.localName =
                  t.settings.localName || t.settings.name),
                (t.availableInterfaces = [t.settings.ipsettings]),
                t.settings.ipsettingsWifi &&
                  t.availableInterfaces.push(t.settings.ipsettingsWifi),
                ...
                t.settings.sleep &&
                  ...
                  ((t.settings.sleep.ontimeObj = new Date(0)),
                  (a = e(t.settings.sleep.ontime)),
                  t.settings.sleep.ontimeObj.setHours(a.h),
                  t.settings.sleep.ontimeObj.setMinutes(a.m)),
                t.settings.sleep &&
                  t.settings.sleep.offtime &&
                  ((t.settings.sleep.offtimeObj = new Date(0)),
                  (a = e(t.settings.sleep.offtime)),
                  t.settings.sleep.offtimeObj.setHours(a.h),
                  t.settings.sleep.offtimeObj.setMinutes(a.m)));
            },
            function (e) {
              d.status({
                msg:
                  r(
                    "No response, player may be rebooting to change settings: "
                  ) + e.status,
              });
            }
          ),
          (t.saveName = function () {
            l.post(s.settings + "hostname", t.settings).then(
              function (e) {
                e.data.success &&
                  (t.settings_name.$setPristine(),
                  (t.statusMessage.saveName = r("Changes have been saved")));
              },
              function (e) {
                t.statusMessage.saveName =
                  r(
                    "No response, player may be rebooting to change settings: "
                  ) + e.status;
              }
            ...
            l.post(s.piswupdate, {}).then(
              function (e) {
                ...
                (t.disableButtons.swUpdate = !0),
                  (t.statusMessage.swUpdate = r(
                    "Player will update the software & reboot"
                  )),
                  t.modal.close(),
                  c(function () {
                    m.location.reload();
          ...
          (t.saveIp = function () {
            t.networkform.$setPristine(),
              ...
              l.post(s.settings + "ethernet", t.settings).then(
                function (e) {
                  e.data.success
                    ? ((t.statusMessage.saveIp = r(
                        "Player will update the IP settings & reboot"
                      )),
                      c(function () {
                        m.location.reload();
                      }, 5e3))
                    : (t.networkform.$setDirty(),
                      (t.statusMessage.saveIp = r(
                        "Network interface file I/O error"
                      )));
                },
                function (e) {
                  t.networkform.$setDirty(),
                    (t.statusMessage.saveIp =
                      r(
                        "No response, player may be rebooting to change settings: "
                      ) + e.status);
                }
          ...
          (t.saveWifi = function () {
            t.wifiform.$setPristine(),
              ...
              (t.settings.wifi.countryCode =
                t.settings.wifi.country && t.settings.wifi.country.code),
              l.post(s.settings + "wifi", t.settings).then(
                function (e) {
                  e.data.success
                    ? (t.statusMessage.saveWifi = r(
                        "Player has updated the wifi settings"
                      ))
                    : (t.wifiform.$setDirty(),
                      (t.statusMessage.saveWifi = r(
                        "Wifi interface file I/O error"
                      )));
                },
                function (e) {
                  t.wifiform.$setDirty(),
                    (t.statusMessage.saveWifi =
                      r(
                        "No response, player may be rebooting to change settings: "
                      ) + e.status);
                }
                ...
                function (e) {
                  e.data.success
                    ? (t.serverform.$setPristine(),
                      (t.statusMessage.serverChange = r(
                        "Server name has been reconfigured, player will reload the program"
                      )),
                      c(function () {
                        m.location.reload();
                      }, 5e3))
                    : (t.statusMessage.serverChange = r(
                        "Error in writing to configuration file"
                      ));
                },
                function (e) {
                  t.statusMessage.serverChange =
                    r(
                      "No response, player may be rebooting to change settings: "
                    ) + e.status;
                }
          ...
          (t.resize = function (e) {
            (t.settings.overscan.horizontal = parseInt(
              t.settings.overscan.horizontal,
              10
            )),
              (t.settings.overscan.vertical = parseInt(
                t.settings.overscan.vertical,
                10
              )),
                ...
                function (e) {
                  e.data.success
                    ? (t.overscanform.$setPristine(),
                      (t.statusMessage.resize = r(
                        "Player will reboot to effect the changes"
                      )),
                      c(function () {
                        m.location.reload();
                      }, 5e3))
              ...
              function (e) {
                e.data.success
                  ? (t.userform.$setPristine(),
                    (t.statusMessage.userChange = r(
                      "User settings has been written, player will reload the program"
                    )),
                    c(function () {
                      m.location.reload();
                    }, 5e3))
          ...
          (t.sleepEnable = function () {
            ...
            t.settings.sleep &&
              ...
              ((a = t.settings.sleep.ontimeObj.getHours()),
              (t.settings.sleep.ontime = a < 10 ? "0" + a : "" + a),
              (e = t.settings.sleep.ontimeObj.getMinutes()),
              (t.settings.sleep.ontime += e < 10 ? ":0" + e : ":" + e)),
              t.settings.sleep &&
              ...
              l.post(s.settings + "sleep", t.settings).then(
                function (e) {
                  e.data;
                  t.scheduleform.$setPristine(),
                    (t.statusMessage.sleepEnable = r(
                      "Settings have been saved"
                    ));
                },
                function (e) {
                  t.statusMessage.sleepEnable =
                    r(
                      "No response, player may be rebooting to change settings: "
                    ) + e.status;
                }
            ...
            (t.modalmsg = "searching networks ... "),
              ...
              l.get(s.settings + "wifiscan").then(
                function (e) {
                  e = e.data;
                  e.success
                    ? ((t.modalmsg = null), (t.networks = e.data))
                    : (t.modalmsg = "An error occured while searching");
                },
                function (e) {
          ...
          (t.changeOmxVolume = function () {
            (t.settings.omxVolume = parseInt(t.settings.omxVolume, 10)),
              l.post(s.settings + "omxVolume", t.settings).then(
                function (e) {
                  e.data;
                  t.volumeform.$setPristine(),
                    (t.statusMessage.changeOmxVolume = r(
                      "Settings have been saved"
                    ));
                },
                function (e) {
                  t.statusMessage.changeOmxVolume =
                    r(
                      "No response, player may be rebooting to change settings: "
                    ) + e.status;
                }
          ...
          (t.seleted = function (e) {
            (t.settings.wifi = t.settings.wifi || {}),
              (t.settings.wifi.ssid = e),
              (t.settings.wifi.pass = null),
              t.modal.close();
          }),
              ...
              (t.ok = function () {
                l.post(s.settings + "reset", {}).then(
                  function (e) {
                    e.data.success
                      ? (t.modal.close(),
                        (t.statusMessage.factoryReset = r(
                          "Changed settings to factory default & rebooting the player"
                        )),
                        c(function () {
                          m.location.reload();
                        }, 5e3))
                      : (t.statusMessage.factoryReset = r(
                          "Error in executing factory reset command"
                        ));
                  },
                  function (e) {
                    t.statusMessage.factoryReset =
                      r(
                        "No response, player may be rebooting to change settings: "
                      ) + e.status;
                  }
          ...
          (t.saveSettingsFile = function () {
            l.post(s.settingsfile, t.settingsData).then(
              function (e) {
                e.data;
                t.statusMessage.settingsFile = r(
                  "Settings file has been saved and server will restart"
                );
              },
              function (e) {
                t.statusMessage.settingsFile =
                  r(
                    "No response, player may be rebooting to change settings: "
                  ) + e.status;
              }
      ...
      function (o, e, s, l, n, t, i, a, r, d, c, m, u, p, f, g) {
        ...
        function v(e) {
          e.forEach(function (e) {
            e.isIntersecting &&
              ((e.target.src = e.target.dataset.src), b.unobserve(e.target));
          });
        }
        ...
        function h() {
          n.get(l.files, {}).then(
            function (e) {
              ...
              if (e.success) {
                if (
                  ((o.sizes = e.data.sizes),
                  o.sizes.total &&
                    o.sizes.used > o.sizes.total &&
                    (o.sizes.maxSizeExceeded = !0),
                  (o.files = e.data.files),
                  y(),
                  e.data.dbdata && 1 != e.data.player)
                ) {
                  ...
                  e.data.dbdata.forEach(function (e) {
                    0 <= o.files.indexOf(e.name) &&
                      (o.filesDetails[e.name] = e);
                  }),
                  o.filesDetails))
                  ...
                  o.files.forEach(function (t) {
                    o.filesDetails[t] &&
                      (t.includes(".weblink") ||
                        ...
                        t.includes(".txt")) &&
                      (t.includes(".txt") ||
                        (o.filesDetails[t].type = t.split(".")[1]),
                      n.get(l.links + t).then(function (e) {
                        if (e.data)
                          try {
                            var a = JSON.parse(e.data.data.data);
                            t.includes("txt")
                              ? (o.filesDetails[t].message = a.message)
                              : (o.filesDetails[t].link = a.link);
                          } catch (e) {
        ...
        o.$on("$destroy", function () {
            ...
            (o.uploadedFiles = e),
              a.data &&
                a.data.forEach(function (e, a) {
                  (o.uploadedFiles[a].name = e.name),
                    -1 == o.files.indexOf(e.name) && o.files.push(e.name);
                }),
              a.success
                ? (o.msg = {
                    title: m("Upload"),
          ...
          (o.addLabel = function () {
            n.post(l.labels, o.newLabel).then(
              function (e) {
                e = e.data;
                e.success
                  ? (o.upload.selectedLabels.push(e.data.name),
                    o.upload.labels.push(e.data),
                    (o.newLabel = {
                      mode: g.current.data && g.current.data.labelMode,
                    }),
                    (o.msg.error = null))
                  ...
                  function (e) {
                    ...
                    e.success
                      ? (o.msg = {
                          ...
                          msg: m(
                            "If there is a need for conversion, it will take few minutes to appear in assets"
                          ),
                          disable: !1,
                          btnTxt: m("OK"),
                          dismiss: !0,
            ...
            (e.match(/.gcal$/i) && o.hideGcal) ||
              (e.match(/^custom_layout.*html$/)
                ? f.status({
                    msg:
                      e +
                      " is a custom layout template file, preview is not available",
                  })
                : e.match(/.html$/i)
          ...
          (o.label_search = function (e) {
            return (
              !i.selectedLabel ||
              (o.filesDetails[e.filename || e] &&
                0 <=
                  o.filesDetails[e.filename || e].labels.indexOf(
                    i.selectedLabel
                  ))
            );
          }),
          (o.sortingFn = function (e) {
            return new Date(
              o.filesDetails[e.filename || e]
                ? o.filesDetails[e.filename || e].createdAt
                : 0
            ).getTime();
          }),
          (o.loadMore = function () {
        ...
        var y = function () {
          n.get(l.playlists, {}).then(
            function (e) {
              e = e.data;
              e.success &&
                ((o.unassigned = []), (o.customPl.playlist = e.data));
            },
            function (e) {}
          );
        };
        (o.ext = ""),
          ...
          (o.toggleSelection = function () {
            o.files.forEach(function (e) {
              o.label_search(e) &&
                (!o.search || -1 < e.indexOf(o.search)) &&
                o.extension(e) &&
                (o.filtered.selected[e] = o.filtered.selectAll);
            });
          }),
          (o.groups = {}),
          (o.selectedGroups = []),
              ...
              o.files.forEach(function (e) {
                ...
                (n = o.filesDetails[e]
                  ? ((n = o.filesDetails[e].type || " "),
                    ...
                    (t = o.filesDetails[e].resolution
                      ? o.filesDetails[e].resolution.width +
                        "X" +
                        o.filesDetails[e].resolution.height
                      : " "),
                    ...
                    [
                      e,
                      "text" == n
                        ? o.filesDetails[e].message
                        : o.filesDetails[e].link || " ",
                      n,
                      a,
                      t,
                      s,
          ...
          (o.doBulkOperation = function (e) {
            (o.bulkSelectedFiles = []),
              o.adminServer && 1 === Object.keys(o.filtered.selected).length
                ? (o.upload.selectedLabels =
                    o.filesDetails[
                      Object.keys(o.filtered.selected)[0]
                    ].labels.slice())
                : (o.upload.selectedLabels = []),
                ...
                switch (o.operation) {
                  case "delete":
                    n.delete(l.files + encodeURIComponent(a)).then(
                      function (e) {
                        e.data.success &&
                          (o.files.splice(o.files.indexOf(a), 1), (s += 1)),
                          t();
                      },
                      function (e) {
                        t();
                  ...
                  case "assign":
                    ...
                    (o.filesDetails[a].labels = o.upload.selectedLabels),
                      n
                        .post(l.files + encodeURIComponent(a), {
          ...
          (o.assignAsset = function (e) {
            p.popUp(
              e,
              o.customPl.playlist,
              o.filesDetails && o.filesDetails[e]
                ? o.filesDetails[e].duration
                : null
            );
          }),
          (o.scheduleValidity = function (e) {
            o.forAsset = e;
            e = (o.filesDetails[o.forAsset] &&
              o.filesDetails[o.forAsset].validity) || {
              enable: !1,
            };
            e.startdate && (e.startdate = new Date(e.startdate)),
              ...
              o.$watch(
                "filesDetails[forAsset].validity.startdate",
                function (e, a) {
                  !e ||
                    ...
                    (!o.filesDetails[o.forAsset].validity.enddate ||
                      e > o.filesDetails[o.forAsset].validity.enddate) &&
                      ((o.filesDetails[o.forAsset].validity.enddate = a),
                      (o.filesDetails[o.forAsset].validity.endhour = 24)));
                }
              ),
          ...
          (o.download = function (t, e) {
            t.match(/.(tv|stream|link|weblink|mrss|radio|local)$/i) &&
              f
                .status({
        ...
        1 == e.disableDownload
          ...
          (a.save = function () {
            t.post(s.files + encodeURIComponent(l.file), {
              ...
              function (e) {
                e = e.data;
                e.success &&
                  ((a.filedetails.dbdata = e.data), n.path("/assets"));
              },
              function (e) {}
            );
          }),
          ...
          (a.assignAsset = function (e) {
            o.popUp(
              l.file,
              a.playlists,
              a.filesDetails && a.filesDetails.dbdata
                ? a.filedetails.dbdata.duration
                : null
            );
          }),
      ...
      function (t, e, s, l, a, n, i, o, r, d, c) {
        (t.userIsAdmin = e.currentUser && e.currentUser.superRole),
          ...
          (t.label_search = function (e) {
            return (
              !d.selectedLabel ||
              (e && e.labels && 0 <= e.labels.indexOf(d.selectedLabel))
            );
          }),
          ...
          (t.delete = function (e) {
            ...
            o.confirm(t.files[a], function () {
              s.delete(l.files + encodeURIComponent(t.files[a])).then(
                function (e) {
                  e.data.success &&
                    (t.files.splice(a, 1), t.names.splice(a, 1));
                },
                function (e) {}
              );
            });
      ...
      function (s, l, n, i) {
        s.rename = function (e) {
          ...
          !s.names[a].name || 0 <= s.files.indexOf(t)
            ? ((s.names[a].name = i("File name exists or empty name")),
              s.editform.$setPristine(),
              (s.fieldStatus = "has-error"))
            : l
                .post(n.files + encodeURIComponent(e), {
                  newname: t,
                })
                .then(
                  function (e) {
    ...
    .controller("AssetViewPopupCtrl", [
      ...
      function (a, e, t, s, l, n, i) {
        ...
        if (
          ...
          !a.fileToShow || a.fileToShow.match(/.gcal$/))
        )
          a.modal.close();
        else {
          switch (
            ((o = a.fileToShow).match(
              /.(tv|stream|link|weblink|mrss|radio|local)$/i
            )
              ? (a.fileType = "link")
              : o.match(/.html$/i)
              ? (a.fileType = "notice")
                ...
                function (e) {
                  ...
                  e.success
                    ? ((e = e.data.data),
                      ...
                      (a.previewimagepath = e.image
                        ? decodeURIComponent("/media/" + e.image)
                        : null))
                    : ((a.fileType = "missing"),
                      (a.warningMsg =
                        "Information regarding " + o + " could not be found"));
                },
                function (e) {}
              );
              break;
            ...
            case "text":
              s.get(t.links + encodeURIComponent(o)).then(
                function (e) {
                  e = e.data;
                  e.success
                    ? (a.urlLink = JSON.parse(e.data.data))
                    : ((a.fileType = "missing"),
                      (a.warningMsg =
                        "Information regarding " + o + " could not be found"));
                },
        ...
        (t.noticename = n.file),
                ...
                function (e) {
                  ...
                  e.success
                    ? ((a = e.data.data),
                      ...
                      (t.previewimagepath = a.image
                        ? decodeURIComponent("/media/" + a.image)
                        : null))
                    : (o.status({
                        msg:
          ...
          (t.noticedone = function (e, a) {
            t.previewimagepath &&
              ...
              (t.errmsg = null),
              (t.previewimagepath =
                "/media/" + encodeURIComponent(a.data[0].name));
          }),
          (t.saveNotice = function () {
            var e = "new" != n.file ? n.file : "",
              a = {
                ...
                image: t.previewimagepath
                  ? t.previewimagepath.split("/")[2]
                  : "",
            ...
            s.post(l.notices + e, {
              ...
              function (e) {
                ...
                e.success &&
                  ((t.noticePreview = !0),
                  (a = e.data.indexOf("img src=")),
                  (e =
                    e.data.slice(0, a + 9) + "/media/" + e.data.slice(a + 9)),
                  (t.serverPreview = i.trustAsHtml(e)));
              },
              function (e) {}
            );
          }),
        ...
        t.get(s.files + n.file).then(
          ...
          (a.saveTags = function () {
            t.post(s.files + n.file, {
              ...
              function (e) {
                e = e.data;
                e.success &&
                  ((a.filedetails.dbdata = e.data), l.path("/assets"));
              },
              function (e) {}
            );
          }),
          t.get(s.links + n.file).then(
            function (e) {
              ...
              e.success
                ? ((a.urlLink = JSON.parse(e.data.data)),
                  (a.urlLink.hideTitle = a.urlLink.hideTitle || "title"))
                : (o.status({
                    msg:
                      "Information regarding " +
                      n.file +
  ...
  angular
      ...
      function (n, i, a, t, e, o, s, l, r, d, c, m, u, p, f) {
              ...
              e.success &&
                ...
                n.playlists.forEach(function (e) {
                  n.adminServer &&
                    ...
                    e.groupIds &&
                    e.groupIds.length &&
                    (n.groupLists[e.name] = n.showGroupNames(e.groupIds)),
                    "TV_OFF" !== e.name &&
                      e.labels &&
                    ...
                    Array.isArray(e.belongsTo) && e.belongsTo.length
                      ? (e.belongsTo = e.belongsTo.join(", "))
                      : (e.belongsTo = "");
                })),
                (n.adminServer = !1),
                          ...
                          e.success &&
                            ...
                            n.groups &&
                              ...
                              n.playlists.forEach(function (e) {
                                e.groupIds &&
                                  e.groupIds.length &&
                                  (n.groupLists[e.name] = n.showGroupNames(
                                    e.groupIds
                                  ));
                              })),
                            n.showDates();
        ...
        (n.userIsAdmin = u.currentUser && u.currentUser.superRole),
          ...
          (n.label_search = function (e) {
            return (
              !c.selectedLabel ||
              (e && e.labels && 0 <= e.labels.indexOf(c.selectedLabel))
            );
          }),
          ...
          (n.add = function () {
            if (!n.newPlaylist)
              return (
                (n.statusText = l("Empty name not allowed")),
                n.addform.$setPristine(),
                void (n.fieldStatus = "has-error")
              );
            n.newPlaylist = n.newPlaylist.replace(d.groupNameRegEx, "");
            for (var e = 0; e < n.playlists.length; e++)
              if (n.playlists[e].name == n.newPlaylist)
                return (
                  (n.statusText = l("Playlist exists already")),
                  n.addform.$setPristine(),
                  void (n.fieldStatus = "has-error")
                );
            i.post(o.playlists, {
              ...
              function (e) {
                e.data.success &&
                  ...
                  n.addform.$setPristine(),
                  (n.fieldStatus = "has-success"),
                  n.loadPlaylist(n.newPlaylist));
              },
              function (e) {}
            );
          }),
          ...
          (n.makeCopy = function (a) {
            for (
              var t, e = a.name + "-copy", s = 0;
              s < n.playlists.length;
              s++
            )
              if (n.playlists[s].name == e)
                return void r.status({
            ...
            r.confirm(a.name, function () {
              i.delete(o.files + "__" + a.name + ".json").then(
                function (e) {
                  e.data.success &&
                    ((e = n.playlists.indexOf(a)),
                    n.playlists.splice(e, 1),
                    (n.weekDaysText[a.name] = ""),
                    (n.monthDaysText[a.name] = ""),
                    delete n.groupLists[a.name]),
                    s();
                },
                function (e) {
                  s();
          ...
          (n.toggleSelection = function () {
            n.playlists.forEach(function (e) {
              "TV_OFF" !== e.name &&
                n.label_search(e) &&
                (!n.search || -1 < e.name.indexOf(n.search)) &&
                (n.filtered.selected[e.name] = n.filtered.selectAll);
            });
          }),
          (n.groups = {}),
          (n.selectedGroups = []),
          ...
          (n.doBulkOperation = function (e) {
            if (
              ...
              (n.upload.labels = []),
              1 === Object.keys(n.filtered.selected).length)
            ) {
              for (
                var a = 0;
                a < n.playlists.length &&
                ("TV_OFF" === n.playlists[a].name ||
                  n.playlists[a].name !== Object.keys(n.filtered.selected)[0]);
                a++
              );
              a < n.playlists.length &&
                (n.upload.selectedLabels = n.playlists[a].labels.slice());
            }
            Object.keys(n.filtered.selected).forEach(function (e) {
              n.filtered.selected[e] &&
                "TV_OFF" !== e &&
                n.bulkSelectedFiles.push(e);
            }),
              (n.filtered = {
                selectAll: !1,
                selected: {},
          ...
          (n.addLabel = function () {
            i.post(o.labels, n.newLabel).then(
              function (e) {
                e = e.data;
                e.success
                  ? (n.upload.selectedLabels.push(e.data.name),
                    n.upload.labels.push(e.data),
                    (n.newLabel = {
                      mode: t.current.data && t.current.data.labelMode,
                    }),
                    (n.msg.error = null))
                ...
                switch (n.operation) {
                  ...
                  case "assign":
                    ...
                    i.post(o.playlists + e, {
                      ...
                      function (e) {
                        e.data.success &&
                          ((t.labels = e.data.data.labels), (l += 1)),
                          a();
                      },
                      function (e) {
                  ...
                  case "group":
                    ...
                    i.post(o.playlists + e, {
                      ...
                      function (e) {
                        e.data.success &&
                          ((t.groupIds = n.selectedGroups),
                          (n.groupLists[t.name] = n.showGroupNames(
                            n.selectedGroups
                          )),
                          (l += 1)),
                          a();
          ...
          (n.showDates = function () {
            ...
            for (var e = 0, a = n.playlists.length; e < a; e++) {
              ...
              (n.weekDaysText[n.playlists[e].name] = t.weekDaysText),
                ...
                (n.playlists[e].scheduleExists =
                  n.playlists[e].schedule &&
                  0 < Object.keys(n.playlists[e].schedule).length);
            }
          }),
          (n.scheduleCalendar = function (a, e) {
            ...
            function t() {
              ...
              (n.weekDaysText[a.name] = e.weekDaysText),
                (n.monthDaysText[a.name] = e.monthDaysText),
                (n.weeknumbersText[a.name] = e.weeknumbersText),
                (a.scheduleExists =
                  a.schedule && 0 < Object.keys(a.schedule).length);
            }
            e
              ? ((a.schedule = {}), t())
              : ((a.schedule = a.schedule || {}),
                f.scheduleCalendar(a.name, a.schedule, n, t));
          });
      },
    ])
    .controller("PlaylistViewCtrl", [
      ...
      function (o, l, r, n, i, t, e, a, d, s, c, m, u, p, f, g, b, v, h, y) {
        (o.userIsAdmin = r.currentUser && r.currentUser.superRole),
          ((o.selLabel = c).selectedLabel = null),
          (o.navbar = {}),
          (o.filtered = {}),
          (o.status = {
            plainView: !0,
        ...
        function w() {
          r.uiDefaults &&
            ((o.status.plainView =
              !r.uiDefaults.playlistView ||
              "list" === r.uiDefaults.playlistView),
            (o.multiSelect = "dnd-multi" === r.uiDefaults.playlistView));
        }
        w(),
          ...
          (o.changeView = function (e) {
            var a;
            (o.filtered.playlistForDisplay = o.status.plainView
              ? o.filtered.playlistItemsFiltered
              : o.filtered.customPlPlaylistFiltered),
              ((a = r.uiDefaults).playlistView = o.status.plainView
                ? "list"
                : o.multiSelect
                ? "dnd-multi"
                : "dnd"),
              l
                .post(n.installationsettings, {
                  settings: {
                    uiDefaults: a,
                  },
                })
          ...
          l.get(n.getStatus, {}).then(
            function (e) {
              ...
              if (e.data.server)
                return (
                  (o.navbar.showPrimaryButton = !1), void (o.adminServer = !0)
                );
              e.data.playlistOn
                ? ((o.navbar.primaryButtonText = g("STOP")),
                  (o.navbar.primaryButtonId = "STOP"),
                  (o.navbar.primaryButtonTypeClass = "btn-danger"))
                : ((o.navbar.primaryButtonText = g("PLAY")),
                  (o.navbar.primaryButtonId = "PLAY"),
                  (o.navbar.primaryButtonTypeClass = "btn-info"));
            },
            function (e) {}
          ),
          (o.title = d.file),
        ...
        function k(e) {
          return (
            o.filesDetails &&
            o.filesDetails[e.filename] &&
            o.filesDetails[e.filename].labels &&
            0 <= o.filesDetails[e.filename].labels.indexOf(c.selectedLabel)
          );
        }
        ...
        function A() {
          if (o.playlistLoaded && o.assetsLoaded) {
            var e,
              a = [];
            for (e in ((o.customPl.unassigned = []),
            (o.customPl.playlist = []),
            ...
            o.playlistItems))
              a.push(o.playlistItems[e].filename),
                o.playlistItems[e].filename.match(u.videoRegex) &&
                  (o.playlistItems[e].isVideo = !0),
                (o.playlistItems[e].option = o.playlistItems[e].option || {
                  main: !1,
                }),
                (o.playlistItems[e].selected
                  ? o.customPl.playlist
                  : o.customPl.unassigned
                ).push(o.playlistItems[e]);
            o.selectedItemsLength = o.customPl.playlist.length;
            for (var t, s, l = 0, n = o.assets.length; l < n; l++)
              -1 == a.indexOf(o.assets[l]) &&
                ((t =
                  o.filesDetails && o.filesDetails[o.assets[l]]
                    ? parseInt(o.filesDetails[o.assets[l]].duration)
                    : t) ||
            ...
            P(),
              o.layout.templateName &&
              0 === o.layout.type.indexOf("custom") &&
              0 <= o.assets.indexOf(o.layout.templateName)
        ...
        var S,
          ...
          P = function () {
            ...
            (o.playlistItems = o.playlistItems.filter(function (e) {
              ...
              (t = c.selectedLabel
                ? ((e = f(o.playlistItems, k)),
                  (a = o.customPl.playlist),
                  f(o.customPl.unassigned, k))
                : ((e = o.playlistItems),
                  (a = o.customPl.playlist),
                  o.customPl.unassigned)),
              o.search
                ? ((o.filtered.playlistItemsFiltered = f(e, x)),
                  (o.filtered.customPlPlaylistFiltered = a),
                  (o.filtered.customPlUnassignedFiltered = f(t, x)))
                : ((o.filtered.playlistItemsFiltered = e),
                  (o.filtered.customPlPlaylistFiltered = a),
                  (o.filtered.customPlUnassignedFiltered = t)),
              (o.filtered.playlistForDisplay = o.status.plainView
                ? o.filtered.playlistItemsFiltered
                : o.filtered.customPlPlaylistFiltered);
          },
                  ...
                  l.get(n.customTemplate + e, {}).then(
                    function (e) {
                      ...
                      a.success &&
                        ...
                        b.custom.forEach(function (e) {
                          a.data.properties[e] &&
                            a.data.properties[e].enable &&
                            ((o.customZonesPresent[e] = !0),
                            (o.aliasNames[e] =
                              a.data.properties[e].aliasName || e));
                        });
                    },
                    function (e) {}
                  );
          ...
          M =
            (o.$watch("playlist.form.$dirty", function (e, a) {
              if (e) {
                for (var t = o.customPl.playlist.length, s = 0; s < t; s++) {
                  ...
                  if (!l.selected) {
                    o.customPl.unassigned.push(l),
                      o.customPl.playlist.splice(s, 1);
                    break;
                  }
                }
              ...
              function (e) {
                ...
                e.success
                  ? ((a = e),
                    ...
                    (o.settings.ticker = o.settings.ticker || {
                      enable: !1,
                    }),
                    (o.settings.ticker.behavior =
                      o.settings.ticker.behavior || "scroll"),
                    (o.settings.ticker.textSpeed =
                      o.settings.ticker.textSpeed || 3),
                    (o.settings.ticker.rss = o.settings.ticker.rss || {
                      enable: !1,
                      link: null,
                      feedDelay: 10,
                    }),
                    ...
                    (o.settings.audio = o.settings.audio || {
                      enable: !1,
                      random: !1,
                      volume: 50,
                    }),
                    ...
                    (o.layout = {
                      ...
                      mainzoneOnly:
                        (a.data.videoWindow &&
                          a.data.videoWindow.mainzoneOnly) ||
                        !1,
                    }),
                    (o.playlistLoaded = !0),
                    A())
            ...
            l.get(n.files, {}).then(
              function (e) {
                ...
                if (e.success) {
                  if (
                    ((o.assets = e.data.files || []),
                    e.data.systemAssets &&
                      (o.assets = o.assets.concat(e.data.systemAssets)),
                    e.data.dbdata)
                  )
                    ...
                    e.data.dbdata.forEach(function (e) {
                      0 <= o.assets.indexOf(e.name) &&
                        (o.filesDetails[e.name] = e);
                    }),
                    o.filesDetails))
                      (o.filesDetails[a].muteButtonEnable =
                        a.match(u.videoRegex) ||
                        a.match(u.omxStreamRegex) ||
                        a.match(u.liveStreamRegex)),
                        o.filesDetails[a].labels.forEach(function (e) {
                          c.labelsCount[e] = (c.labelsCount[e] || 0) + 1;
                        });
                  else
                    (o.filesDetails = {}),
                      o.assets.forEach(function (e) {
                        (o.filesDetails[e] = {}),
                          e.match(u.videoRegex) &&
                            (o.filesDetails[e].type = "video"),
                          e.match(u.imageRegex) &&
                            (o.filesDetails[e].type = "image"),
                          e.match(u.noticeRegex) &&
                            (o.filesDetails[e].type = "notice"),
                          (o.filesDetails[e].muteButtonEnable =
                            e.match(u.videoRegex) ||
                            e.match(u.omxStreamRegex) ||
                            e.match(u.liveStreamRegex));
                      });
                  (o.assetsLoaded = !0), A();
                }
              },
        ...
        (o.dragStart = function (e, a) {
          (e.dragging = !0),
            ...
            M ||
              ((M = y(function () {
                var e, a;
                (e = {
                  y: parseInt(0.1 * window.innerHeight),
                }),
                  (a = {
                    y: parseInt(0.9 * window.innerHeight),
                  }),
                  0 < T.y && T.y < e.y
                    ? document.getElementById(S).scrollBy(0, -30)
                    : T.y > a.y && document.getElementById(S).scrollBy(0, 30);
              }, 50)),
              t.on("drag", L));
        }),
          ...
          (o.linkFile = function (e, a) {
            (o.selectedAsset = e)[(o.selectedZone = a)] &&
            0 == e[a].indexOf("__")
              ? (o.tabIndex = 1)
              : (o.tabIndex = 0),
          ...
          (o.openLayout = function () {
            ...
            (o.layouts = [
              ...
              
              {
                ...
                disabled: !e,
                description: g(
                  "Upload custom_layout.html under Assets Tab(otherwise this option is disabled), Use #main,#side, #bottom, #ticker html ID tags for content"
                ),
              },
              {
                type: "customp",
              ...
              },
              {
                type: "customp270",
                title: g(
                  "Custom Layout in Portrait Mode,Orient anti-clockwise"
                ),
                disabled: !e,
                description: g(
                  "Upload custom_layout.html under Assets Tab(otherwise this option is disabled), Use #main,#side, #bottom, #ticker html ID tags for content"
          ...
          (o.saveLayout = function () {
            0 == o.layout.type.indexOf("custom") &&
              ((o.msg = {
                title:
                  "Please adjust video window sizes to match custom layout ",
                msg: "For videos to have right sizes, adjust the video window sizes under layout popup screen for main/side/bottom zones",
              }),
              p.status(o.msg)),
              o.layout.videoWindow &&
                (o.layout.videoWindow.mainzoneOnly = o.layout.mainzoneOnly),
              l
                .post(n.playlists + d.file, {
          ...
          (o.tickerSave = function () {
            if (
              o.settings.ticker.rss &&
              o.settings.ticker.rss.enable &&
              !o.settings.ticker.rss.link
            )
              return (
            ...
            o.settings.ticker.style &&
              (o.settings.ticker.style = o.settings.ticker.style.replace(
                /\"/g,
                ""
              )),
              o.settings.ticker.messages &&
                (o.settings.ticker.messages =
                  o.settings.ticker.messages.replace(/'/g, "`")),
              l
                .post(n.playlists + d.file, {
                  settings: o.settings,
                })
                .then(
                  function (e) {
                    e.data.success &&
                      ((o.warnUser = !0), o.tickerModal.close());
                  },
                  function (e) {
          ...
          (o.pbHandler = function (e, a) {
            ...
            "SAVE" == o.navbar.primaryButtonId || "SAVE" == e
              ? ((t = (
                  o.status.plainView ? o.playlistItems : o.customPl.playlist
                ).filter(function (e) {
                  return e.selected;
                })).forEach(function (e) {
                  0 == b[o.layout.type].length && (e.fullscreen = !0),
                    e.duration < 2 && (e.duration = 2);
                }),
          ...
          (o.randomOrder = function () {
            if (o.status.plainView) {
              I(o.playlistItems);
              for (var e = -1, a = 0, t = o.playlistItems.length; a < t; a++)
                o.playlistItems[a].selected
                  ? -1 != e &&
                    (o.playlistItems.splice(
                      e,
                      0,
                      o.playlistItems.splice(a, 1)[0]
                    ),
                    (e += 1))
                  : -1 == e && (e = a);
                        ...
                        function (e) {
                          ...
                          e.success &&
                            ...
                            o.groups.forEach(function (e) {
                              0 == e.name.indexOf("__player__") &&
                                (e.name = o.players[e.name.slice(10)]);
                            }));
                        },
                        function (e) {}
                      );
          ...
          (t.delete = function (a) {
            i.confirm(o("Playlist"), function () {
              e.delete(l.files + "__" + t.playlists[a].name + ".json").then(
                function (e) {
                  e.data.success &&
                    (t.playlists.splice(a, 1), t.playlistsCopy.splice(a, 1));
                },
                function (e) {}
              ),
                e
                  .post(l.playlistfiles, {
    ...
    .controller("PlaylistsItemCtrl", [
      ...
      function (l, n, i, o) {
        l.rename = function (a) {
          if (!l.playlists[a].name)
            return (
              (l.playlists[a].name = o("Empty name not allowed")),
              l.pleditform.$setPristine(),
              void (l.fieldStatus = "has-error")
            );
          for (var e = 0; e < l.playlistsCopy.length; e++)
            if (l.playlistsCopy[e].name == l.playlists[a].name)
              return (
                (l.playlists[a].name = o("File name already exists")),
                l.pleditform.$setPristine(),
                void (l.fieldStatus = "has-error")
              );
          ...
          n.post(i.files + t, {
            ...
            function (e) {
              e.data.success &&
                ...
                n
                  .post(i.playlists + l.playlists[a].name, {
  ...
  angular
    ...
    .directive("touch", function () {
      return function (e, a) {
        ...
        a.addEventListener("touchstart", t, !0),
          a.addEventListener("touchmove", t, !0),
          a.addEventListener("touchend", t, !0),
          a.addEventListener("touchcancel", t, !0);
      };
    })
    ...
    .directive("notify", [
      ...
      function (s) {
        return {
          ...
          replace: "true",
          template:
            '<div class="col-xs-12 text-center notify" ng-show="show">{{msg}}</div>',
          link: function (e, a, t) {
            (e.msg = "Updated!"),
              e.show &&
                s(function () {
                  (e.show = !1),
                    e.$parent.$parent && (e.$parent.$parent.notify = !1),
                    e.$apply();
                }, 2500);
          },
        };
      ...
      function (s, l, n) {
        return {
          ...
          link: function (t, e, a) {
            (t.label = {}),
              n.current.data &&
                n.current.data.labelMode &&
                (t.labelMode = n.current.data.labelMode),
              s
                .get(l.labels, {
                  params: {
                    mode: t.labelMode,
                ...
                .then(
                  function (e) {
                    e = e.data;
                    e.success &&
                      ((t.label.categories = e.data),
                      t.labels && (t.labels = t.label.categories));
                  },
                  function (e) {}
                ),
              (t.label.toggleSelection = function (e) {
                ...
                -1 < a
                  ? t.selectedLabels.splice(a, 1)
                  : t.selectedLabels.push(e);
              });
          },
        };
      },
          ...
          e.bind("click", function (e) {
            for (var a = 0; a < s.filedetails.length; a++) {
              ...
              (t.href =
                ...
                encodeURIComponent(s.filedetails[a].licenseText)),
                (t.download =
                  "license_" + s.filedetails[a].cpuSerialNumber + ".txt"),
                t.click();
            }
          });
        },
    ...
    .directive("isCompleted", function (l) {
      return {
        ...
        link: function (a, t) {
          var s;
          !(function e() {
            (a.cardCompleted = t.hasClass("StripeElement--complete")),
              (s = l(e, 500));
          })(),
        ...
        link: function (e, l) {
          ...
          e.directiveFn &&
            ...
            (e.directiveFn.setCustomcss = function (e) {
              var a;
              n &&
                ((a = n.getElementById("customcss2")) ||
                  ((a = n.createElement("style")).setAttribute(
                    "id",
                    "customcss2"
                  ),
                  (a.type = "text/css"),
              ...
              n &&
                (e
                  ? ((d.src = "/media/" + a.installation + "/" + e),
                    (d.onload = function () {
                      (d.style.marginLeft = (-this.width / 2) * 0.5 + "px"),
                        (d.style.marginTop = (-this.height / 2) * 0.5 + "px");
                    }))
                  : (d.src = ""));
            }),
            (e.directiveFn.setZone = function (e, a, t, s, l) {
              n &&
                (g[e] ||
                  ...
                  g[e].setAttribute("id", e),
                  g[e].classList.add("zone"),
                  r.appendChild(g[e])),
            ...
            l.bind("load", function (e) {
              ...
              (n = l[0].contentDocument),
                (i = l[0].contentWindow),
                (o = n.body),
                (d = n.getElementById("bg-image")) ||
                  ((d = new Image()).setAttribute("id", "bg-image"),
    ...
    .filter("truncate", function () {
      return function (e, a) {
        ...
        return null == e || 0 == e.length
          ? null
          : !angular.isString(e) || e.length <= a
          ? e
          : String(e).substring(0, a - "...".length) + "...";
      };
    })
    .filter("readable", function () {
      return function (e) {
        for (var a = ""; 4 < e.length; )
          (a += e.slice(0, 4) + "-"), (e = e.slice(4));
        return (a += e);
      };
    }),
  angular
                  ...
                  (c = new XMLHttpRequest()),
                    ...
                    (c.upload.onprogress = function (a) {
                      o.$apply(function () {
                        var e;
                        a.lengthComputable &&
                          (a.loaded == a.total && (m = !0),
                          (e = Math.round((a.loaded / a.total) * 100)),
                          i ? i(e) : s.notify && s.notify(e));
                      });
                    }),
                    (c.onload = function (e) {
                      o.$apply(function () {
                    ...
                    (c.upload.onerror = function (e) {
                      var a =
                        c.responseText ||
                        d("An unknown error occurred posting to '") + t + "'";
                      o.$apply(function () {
                        s.reject(a);
                      });
                    }),
    ...
    .factory("screenlog", [
      ...
      function (a) {
        var t = angular
            .element(document.querySelector("#screenlogelement"))
            .scope(),
    ...
    .factory("onlineStatusInterceptor", [
      ...
      function (a, t) {
        ...
        return {
          response: function (e) {
            return (
              s || ((s = !0), t.$broadcast("onlineStatusChange", s)),
              e || a.when(e)
            );
          },
          responseError: function (e) {
            return (
              s && ((s = !1), t.$broadcast("onlineStatusChange", s)),
              a.reject(e)
            );
          },
        };
          ...
          confirm: function (e, s) {
            return a.open({
              ...
              controller: [
                ...
                function (e, a, t) {
                  0 == t.indexOf("--")
                    ? ((e.noPrepend = !0), (e.deleteText = t.slice(2)))
                    : (e.deleteText = t),
                    (e.ok = function () {
                      a.close("ok"), s();
                    }),
    ...
    .factory("saveChangesPrompt", [
      ...
      function (e, a) {
        ...
        var n = {
            navigate: a(
              "You will loose unsaved changes if you leave this page"
            ),
                  ...
                  (a.selectedAsset = i),
                    s.forEach(function (e, a) {
                      ...
                      e.assets.findIndex(function (e) {
                        ...
                        ? ((s[a].addAssetEnable = !0),
                          (s[a].alreadyPresent = !0))
                        : ((s[a].addAssetEnable = !1),
                          (s[a].alreadyPresent = !1));
                    }),
                    (a.popupPlaylists = s),
                    ...
                    (a.updatePlaylists = function (l) {
                      ...
                      var n = {
                        ...
                        duration:
                          parseInt(e) ||
                          (o.currentUser &&
                            o.currentUser.settings.defaultDuration) ||
                          10,
                        fullscreen: !1,
                      ...
                      async.eachSeries(
                        s,
                        function (s, a) {
                          if (s.addAssetEnable == s.alreadyPresent)
                            return (
                          ...
                          s.addAssetEnable &&
                            (l ? (s.assets = [n]) : s.assets.push(n)),
                            delete s.addAssetEnable,
                            delete s.alreadyPresent,
                            r
                              .post(d.playlists + s.name, {
                                assets: s.assets,
                              })
                              .then(
                                function (e) {
      ...
      function (c, m, u) {
        return {
          listFiles: function (s, l, n, a) {
            for (
              var t = [], i = !1, e = !0, o = s.playlists.length - 1;
              0 <= o;
              o--
            ) {
              var r = s.playlists[o],
              ...
              -1 != d
                ? (l[d].assets.forEach(function (a) {
                    -1 == t.indexOf(a.filename) &&
                      0 != a.filename.indexOf("_system") &&
                      t.push(a.filename),
                          ...
                          0 == a[e].indexOf("__") &&
                            ...
                            -1 != (e = n.indexOf(e)) &&
                              ...
                              l[e].assets.forEach(function (e) {
                                -1 == t.indexOf(e.filename) &&
                                  0 != e.filename.indexOf("_system") &&
                                  t.push(e.filename);
                              })));
                      });
                  }),
                  -1 == t.indexOf("__" + r.name + ".json") &&
                    t.push("__" + r.name + ".json"),
                  l[d].templateName &&
                    -1 == t.indexOf(l[d].templateName) &&
                    t.push(l[d].templateName),
                    ...
                    ? 0 == l[d].assets.length
                      ...
                      : ((r.skipForSchedule = !1),
                        l[d].settings.ads && l[d].settings.ads.adPlaylist
                          ? (r.plType = "advt")
                          : l[d].settings.domination &&
                            l[d].settings.domination.enable
                          ? (r.plType = "domination")
                          : l[d].settings.event && l[d].settings.event.enable
                          ? (r.plType = "event")
                          : l[d].settings.keyPress &&
                            l[d].settings.keyPress.enable
                          ? (r.plType = "keyPress")
              ...
              s.defaultCustomTemplate
                ? async.each(
                    ...
                    function (e, a) {
                      ...
                      if (l[t].templateName == s.defaultCustomTemplate)
                        return a();
                    ...
                    function (e) {
                      a(
                        (i = e
                          ? "Unable to set default custom template to group playlists: " +
                            e
                          : i),
                        s
                      );
                ...
                controller: [
                  ...
                  function (a, e, t, s) {
                    if ((a.isPlaylist = s)) {
                      ...
                      (a.index = 0),
                        (a.files = t.assets),
                        (a.filename = a.files[a.index].filename);
                    } else (a.filename = t), (a.files = null);
                    (a.pauseButtonDisabled = !(
                      a.filename.match(n.videoRegex) ||
                      a.filename.match(n.audioRegex)
                    )),
              ...
              compile: function (e, a, t) {
                return (
                  a.maxFiles
                    ...
                    : ((a.maxFiles = 100), e.removeAttr("multiple")),
                      ...
                      e.bind(d, function (e) {
                        ...
                        if (
                          ("drop" === d &&
                            ...
                            0 < e.originalEvent.dataTransfer.types.length &&
                              0 === a.length &&
                              (e =
                          ...
                          (n.files = []),
                            (n.maxFiles = n.maxFiles || 100),
                            (n.maxFileSizeMb = n.maxFileSizeMb || 5e3);
                          var t = [];
                          if (a.length > n.maxFiles)
                            r(
                              a,
                              "TOO_MANY_FILES",
                              "Cannot upload " +
                            ...
                            for (
                              var s = 0;
                              s < n.maxFiles && !(s >= a.length);
                              s++
                            ) {
                              var l = a[s];
                              n.files.push(l),
                                l.size > 1048576 * n.maxFileSizeMb && t.push(l);
                            }
                            0 < t.length
                              ? r(
                                  t,
                              ...
                              : ((n.autoUpload = "true"),
                                n.autoUpload &&
                                "true" == n.autoUpload.toLowerCase()
                                  ? "imageonly" != i.allow ||
                                    -1 != n.files[0].type.indexOf("image")
                                    ? n.upload()
                                    : n.onerror({
                                        file: n.files[0].name,
                        ...
                        e.bind("dragenter", function (e) {
                          e.stopPropagation(),
                            ...
                            o ||
                              ...
                              ("function" ==
                                typeof e.originalEvent.dataTransfer.types
                                  .contains &&
                                e.originalEvent.dataTransfer.types.contains(
                                  "text/uri-list"
                                ))
                                ? n.$apply(function () {
                                    (n.dragStatus.transferItem = "link"),
                                      (n.dragStatus.inProgress = !0);
                                  })
                                : ((Array.isArray(
                                    e.originalEvent.dataTransfer.types
                                  ) &&
                                  ...
                                  n.$apply(function () {
                                    (n.dragStatus.transferItem = "files"),
                                      (n.dragStatus.inProgress = !0);
                                  })),
                            o++;
                        }),
              ...
              "change" === d
                ? (e.template = function (e, a) {
                    var t =
                      ...
                      s =
                        '<label class="btn btn-primary upload_file_containerlarge btn-block"><input type="file" multiple="" style="opacity: 0;width:100%;height:100%;z-index: 2" title="You can upload multiple files at a time"><span ng-transclude></span></label>';
                    ...
                    function a(a, e) {
                      ...
                      t.forEach(function (e) {
                        ...
                        (window.selectMain = function (e) {
                          l.attributes &&
                            ((l.attributes.attributes.id =
                              l.attributes.attributes.prevId),
                            l.set("content", l.attributes.attributes.prevId),
                            (n[l.attributes.attributes.id] = l)),
                        ...
                        a.Modal.setContent(
                          '<h1><label>Select main zone: </label><select onChange="window.selectMain(this.value)">' +
                            s.join() +
                            "</select></h1>"
                        ),
                        a.Modal.open();
                        ...
                        view: n.extend({
                          initialize: function (e) {
                            n.prototype.initialize.apply(this, arguments),
                              (this.attr.id =
                                this.attr.id || "zone - " + this.cid),
                              (this.model.attributes.content = this.attr.id);
                          },
                        }),
                      }),
            ...
            return (
              ...
              (l =
                a && a.weeknumbers && a.weeknumbers.enable
                  ? ((l = e("weeknumbers: ")),
                    ("four" === a.weeknumbers.modulo
                      ? ["1", "2", "3", "0"]
                      : ["1", "2", "0"]
                    ).forEach(function (e) {
                      !0 === a.weeknumbers[e] &&
                        ("0" === e &&
                          (e = "four" === a.weeknumbers.modulo ? "4" : "3"),
                        (l = l + e + ","));
                    }),
                    l.slice(0, -1))
                  : ""),
          ...
          scheduleValidation: function (t) {
            (t.today = new Date().toISOString().split("T")[0]),
              t.$watch("playlistSettings.startdate", function (e) {
                ...
                e &&
                  ((a = new Date(e)),
                  (t.endday = a.toISOString().split("T")[0]),
                  (!t.playlistSettings.enddate ||
                    e > t.playlistSettings.enddate) &&
                    (t.playlistSettings.enddate = a));
              });
          },
          scheduleCalendar: function (e, s, l, n, a) {
            ...
            function i(e) {
              ...
              o.startdate && o.startdate.setUTCHours(0, 0, 0, 0),
                ...
                o.starttimeObj &&
                  ((t = o.starttimeObj.getHours()),
                  (o.starttime = t < 10 ? "0" + t : "" + t),
                  (a = o.starttimeObj.getMinutes()),
                  (o.starttime += a < 10 ? ":0" + a : ":" + a)),
                o.endtimeObj &&
                  ((t = o.endtimeObj.getHours()),
                  (o.endtime = t < 10 ? "0" + t : "" + t),
                  (a = o.endtimeObj.getMinutes()),
                  (o.endtime += a < 10 ? ":0" + a : ":" + a)),
                s.weekdays && s.weekdays.length < 7
                  ? (s.weekday = s.weekdays[0])
                  : delete s.weekday,
                s.monthdays && s.monthdays.length < 31
                  ? (s.monthday = s.monthdays[0])
                  : delete s.monthday,
                s &&
                  s.weeknumbers &&
                  !s.weeknumbers.modulo &&
                  (s.weeknumbers.modulo = "four"),
            ...
            var o = (l.playlistSettings = s),
              e =
                ...
                t(o.starttime)),
              e =
                (o.starttimeObj.setHours(e.h),
                o.starttimeObj.setMinutes(e.m),
                (o.endtime = o.endtime || "00:00"),
                (o.endtimeObj = new Date(0)),
                t(o.endtime));
            o.endtimeObj.setHours(e.h),
              o.endtimeObj.setMinutes(e.m),
              s.weeknumbers
                ? s.weeknumbers.modulo || (s.weeknumbers.modulo = "four")
                : (s.weeknumbers = {
                    enable: !1,
                    modulo: "four",
                  }),
              ...
              (l.ngDropdown.weekdays.selectedDays =
                l.ngDropdown.weekdays.list.filter(function (e) {
              ...
              (l.ngDropdown.monthdays.selectedDays =
                l.ngDropdown.monthdays.list.filter(function (e) {
          ...
          isValid: function (e) {
            if (e && e.validity && e.validity.enable) {
              ...
              if (
                e.validity.enddate &&
                a >
                  ((a = e.validity.enddate),
                  (a = new Date(a)).setTime(
    ...
    .factory("cordovaPush", [
      ...
      function (e, i) {
        ...
        return function (e, a, t) {
          var s;
          if (void 0 === window.plugins)
            return i.error("PhoneGap plugins not found"), !1;
          if (void 0 === (s = window.plugins.pushNotification))
            return i.error("Push plugin not found"), !1;
          ...
          return (
            ...
            (window.onNotificationAPN = function (e) {
              e.alert,
                e.sound && new Media(o() + "app/sound/purebell.mp3").play(),
                e.badge && s.setApplicationIconBadgeNumber(l, n, e.badge),
                t(
                  null,
                  {
                    message: e.alert,
            ...
            (window.onNotificationGCM = function (e) {
              switch (e.event) {
                case "registered":
                  0 < e.regid.length
                    ? a(e.regid, "android")
                    : i.error("Error: No device registration ID received");
                  break;
                case "message":
                  e.foreground &&
                    new Media(o() + "app/sound/purebell.ogg").play(),
                    t(e.collapse_key, e.payload, "android");
                  break;
                case "error":
    ...
    function (e) {
      ...
      e.put(
        ...
        e.put(
          ...
          '<div class="panel panel-default" ng-show="collaborator.rights.asset.create == true" drop-area=drop-area onstart=upload.started() onprogress=upload.progress(percentDone) onerror="upload.error(files, type, msg)" ondone="upload.done(files, data)" drag-status=dragStatus link-fn=linksPopUp() link-value=urlLink ng-class={dim:dragStatus.inProgress}><div class="alert drop-notification" ng-show=dragStatus.inProgress><h4><i class="fa fa-cloud-upload">&nbsp;</i><span translate=translate>Drop the</span><span>&nbsp;{{ dragStatus.transferItem }}&nbsp;</span><span translate=translate>to upload</span></h4></div><div class="panel-heading top-panel"><div class=row><div class=col-sm-12><img class="img-responsive" src="app/img/main-banner.png"></div></div></div><div class="panel-heading"><div class=row><div class=col-sm-6><h3><span>{{(status.plainView ? (\'Available Assets\'| translate): (\'Playlist wise Assets\'|translate))}}</span><div class="btn-group btn-group-sm navbar-btn pl-5"><button class="btn btn-default btn-sm" ng-click="status.plainView=true;status.plainViewAlpha=true;" title="{{\'Alphabetic wise Listing\' | translate}}" ng-class="{\'active\': status.plainView &amp;&amp; status.plainViewAlpha}"><i class="fa fa-sort-alpha-asc fa-lg"></i></button> <button class="btn btn-default btn-sm" ng-click="status.plainView=true;status.plainViewAlpha=false;" title="{{\'Sorted based on upload time\' | translate}}" ng-class="{\'active\': status.plainView &amp;&amp; !status.plainViewAlpha}"><i class="fa fa-clock-o fa-lg"></i></button></div></h3><small ng-attr-title="{{\'Storage space used/Total storage available\' | translate}}" ng-if=sizes.total>used: {{sizes.used}}MB,total: {{sizes.total}}MB</small><small>,&nbsp;{{files.length}}{{\'Assets\'| translate}}</small></div><div class="col-sm-4 navbar-btn pull-right" uib-dropdown=uib-dropdown><div class="btn-group navbar-btn pull-right"><button class="btn btn-link m-r" ng-csv=getCsvAssets() filename={{assetsFile}} add-bom=add-bom translate=translate>Download List</button> <button class="btn btn-default m-r" ng-click="collaborator.rights.asset.edit &amp;&amp; pbHandler(\'EDIT\')" ng-disabled="collaborator.rights.asset.edit != true" title="{{\'Rename or Delete Assets\' | translate}}" translate=translate>Edit</button> <button class="btn btn-primary" data-toggle=dropdown uib-dropdown-toggle=uib-dropdown-toggle title="{{\'Upload files, Add links, Create notices\' | translate}}" ng-disabled=sizes.maxSizeExceeded><i class="fa fa-plus fa-lg">&nbsp;</i><span translate=translate>Add</span></button><div class="dropdown-menu col-xs-12" uib-dropdown-menu=uib-dropdown-menu><nodeims-file-upload type=large title="{{\'You can upload multiple files at a time\' | translate}}" onstart=upload.started() onprogress=upload.progress(percentDone) onerror="upload.error(files, type, msg)" ondone="upload.done(files, data)"><span translate=translate>Upload Files</span></nodeims-file-upload><a class="btn btn-primary btn-block" ng-click=linksPopUp() title="{{\'You can add Youtube, web, streaming, RSS links here\' | translate}}"><span translate=translate>Add a Link</span></a><a class="btn btn-primary btn-block" ng-click="linksPopUp(\'txt\')" title="{{\'You can add text message here\' | translate}}"><span translate=translate>Add a Message</span></a><a class="btn btn-primary btn-block" href=/assets/notices/new title="{{\'Upload notice_template.ejs to customize notice\' | translate}}"><span translate=translate>Create Notice</span></a><a class="btn btn-primary btn-block" ng-click="linksPopUp(\'local\')" title="{{\'You can local folder/file here\' | translate}}"><span translate=translate>Add a local folder/file</span></a></div></div></div><h6 class=pull-right><i translate=translate>You can also upload files, links by dragging them to this panel</i></h6></div></div></div><ul class=list-group ng-if="files.length &amp;&amp; status.plainView" infinite-scroll=loadMore() infinite-scroll-distance=2><li class="list-group-item bg-default"><div class=row><div class=col-sm-3><div class=form-group><input class="input-sm form-control" placeholder="{{\'Filter by Name\' | translate}}" ng-model=search></div></div><div class=col-sm-3><div class="btn-group btn-group-sm"><button class="btn btn-default" ng-click="setExt(\'v\')" ng-class="{\'active\': ext == \'v\'}" title="{{\'Show Videos\' | translate}}"><i class="fa fa-file-video-o fa-lg"></i></button> <button class="btn btn-default" ng-click="setExt(\'i\')" ng-class="{\'active\': ext == \'i\'}" title="{{\'Show Images\' | translate}}"><i class="fa fa-file-image-o fa-lg"></i></button> <button class="btn btn-default" ng-click="setExt(\'n\')" ng-class="{\'active\': ext == \'n\'}" title="{{\'Show Notices\' | translate}}"><i class="fa fa-file-text-o fa-lg"></i></button> <button class="btn btn-default" ng-click="setExt(\'\')" ng-class="{\'active\': !ext}" title="{{\'Clear filter\' | translate}}"><i class="fa fa-file-o fa-lg"></i></button></div></div><div class=col-sm-3><div class="btn-group btn-group-sm" ng-if="adminServer &amp;&amp; !selLabel.selectedLabel" ng-attr-title="{{\'Click this button to select, edit and add categories\' | translate}}"><button class="btn btn-default-outline" ng-click=loadCategory()><i class="fa fa-tags">&nbsp;</i>{{"Filter by category"| translate}}</button></div><div class="btn-group btn-group-sm" ng-if="adminServer &amp;&amp; selLabel.selectedLabel" ng-attr-title={{selLabel.selectedLabel}}><button class="btn btn-default-outline" ng-click=loadCategory()><i class="fa fa-tags">&nbsp;</i>{{selLabel.selectedLabel.trunc(20)}}</button> <button class="btn btn-warning" ng-click="selLabel.selectedLabel=null;"><i class="fa fa-close"></i></button></div></div><div class="col-sm-1 pull-right"><div class="btn-group-vertical pull-right" uib-dropdown=uib-dropdown><button class="btn btn-default btn-xs" uib-dropdown-toggle=uib-dropdown-toggle><small translate=translate>multiple&nbsp;</small><i class="fa fa-caret-down fa-lg"></i></button><div class="dropdown-menu col-xs-12" uib-dropdown-menu=uib-dropdown-menu><button class="btn btn-default btn-block" ng-click="doBulkOperation(\'group\')" ng-if=adminServer title="{{\'Assign selected files to groups\' | translate}}"><span class=text-muted translate=translate>Assign to Groups</span></button> <button class="btn btn-default btn-block" ng-click="doBulkOperation(\'assign\')" ng-if=adminServer title="{{\'Assign categories to the selected files\' | translate}}"><span class=text-muted translate=translate>Assign Categories</span></button> <button class="btn btn-default btn-block" ng-click="doBulkOperation(\'delete\')" title="{{\'Bulk delete all the selected files\' | translate}}"><span class=text-danger translate=translate>Delete selected files</span></button></div><div class="btn btn-link btn-xs btn-default"><input type=checkbox ng-model=filtered.selectAll title="{{\'Select All\' | translate}}" ng-change=toggleSelection()></div></div></div></div></li><li class="list-group-item truncate" ng-repeat="file in filteredFiles.items = (files | filter:label_search | filter:search | filter:extension)  | orderBy:(status.plainViewAlpha?&quot;&quot;:sortingFn):!status.plainViewAlpha| limitTo:infiniteScrollLength"><div class=media><div class=media-body><div class=col-sm-8 ng-click=loadAsset(file)><a ng-href=#><video src="media/{{file}}" height="200" width="350"></video><h4>{{file.split(".")[0]}}</h4></a></div><div class=col-sm-4><div class="btn-toolbar pull-right"><button class="btn btn-primary-outline btn-xs" title="{{\'Add validity period for the asset\' | translate}}" ng-if=adminServer ng-click=scheduleValidity(file)><i class="fa fa-calendar">&nbsp;</i><small ng-if="!(filesDetails[file.filename || file].validity.enable)" translate=translate>add validity</small><small ng-if="filesDetails[file.filename || file].validity.enable"><small>{{filesDetails[file.filename || file].validity.startdate | date:\'MMM d\':\'UTC\'}}</small><small class=text-muted ng-if="filesDetails[file.filename || file].validity.startdate &amp;&amp; filesDetails[file.filename || file].validity.starthour">({{filesDetails[file.filename || file].validity.starthour}}h)</small><small>-</small><small>{{filesDetails[file.filename || file].validity.enddate | date:\'MMM d\':\'UTC\'}}</small><small class=text-muted ng-if="filesDetails[file.filename || file].validity.enddate &amp;&amp; filesDetails[file.filename || file].validity.endhour">({{filesDetails[file.filename || file].validity.endhour}}h)</small></small></button> <button class="btn btn-primary-outline btn-xs" title="{{\'Add or Remove this asset from multiple playlists\' | translate}}" ng-if=adminServer ng-click=assignAsset(file)><small translate=translate>Assign playlists</small></button> <button class="btn btn-default" ng-if=!adminServer ng-click=playAsset(file)><small translate=translate>Play</small></button> <button class="btn btn-xs btn-link" ng-attr-title="{{\'delete\' | translate}}" ng-click=delete(file)><i class="fa fa-trash text-danger fa-6"></i></button> <button class="btn btn-xs btn-link" ng-hide=disableDownload title="{{\'Download asset\'| translate}}" ng-click=download(file,$index)><i class="fa fa-download fa-6"></i></button> <button class="btn btn-xs btn-outline-secondary pl-10"><input type=checkbox id=file name=checkbox ng-model=filtered.selected[file]></button></div></div></div><div class=row ng-if="filesDetails[file.filename || file]"><div class=col-sm-7><small>{{filesDetails[file.filename || file].type}}</small><small class=pl-10 ng-if="filesDetails[file.filename || file].duration &gt; 0"><span>{{filesDetails[file.filename || file].duration}}</span><span class=text-muted translate=translate>&nbsp;seconds</span></small><small class=pl-10 ng-if="filesDetails[file.filename || file].resolution.width"><span>{{filesDetails[file.filename || file].resolution.width}}x{{filesDetails[file.filename || file].resolution.height}}</span></small><small class=pl-10>{{filesDetails[file.filename || file].size}}</small><small class="text-muted pl-5" translate=translate>uploaded on:</small><small>{{filesDetails[file.filename || file].createdAt | date: \'MMM dd,yy\'}}</small><small class="text-muted pl-5" translate=translate>by:</small><small>{{filesDetails[file.filename || file].createdBy.name}}</small></div><div class=col-sm-5><p class=truncate><small class=text-muted translate=translate>Categories:&nbsp;</small><small>{{filesDetails[file.filename || file].labels.toString() || "None"}}</small></p></div></div></div><div class=row><div class=col-sm-12><small translate=translate><small class=text-muted>Playlists:&nbsp;</small><small style="word-wrap: break-word;" ng-repeat="pl in filesDetails[file.filename || file].playlists track by $index"><a href=/playlists/details/{{pl}}>{{pl}}&nbsp;</a></small></small></div></div><div class=row ng-show="filesDetails[file.filename || file].groupIds.length"><div class=col-sm-12><small class=text-muted translate=translate>Groups:&nbsp;</small><small style="white-space:normal;word-wrap: break-word;">{{filesDetails[file.filename || file].groupNames}}</small></div></div></div></li><li class=list-group-item ng-show="infiniteScrollLength &lt; files.length"><button class="btn btn-success btn-block" ng-click="infiniteScrollLength=10000;" translate=translate>Load All</button></li></ul><div ng-hide=files.length><h4 class=text-center translate=translate>No media assets found, Upload assets using Add button</h4></div><div ng-if="customPl.playlist.length &amp;&amp; !status.plainView"><uib-accordion close-others=false><div ng-repeat="playlist in customPl.playlist" uib-accordion-group=uib-accordion-group><uib-accordion-heading><h4 class=row ng-click="open = !open"><small class="text-success col-sm-1"><b><i class="fa fa-lg" ng-class="{\'fa-caret-down\':open,\'fa-caret-right\':!open}">&nbsp;</i></b></small><div class="text-primary col-sm-5">{{playlist.name}}&nbsp;<span><small>({{pfiltered.length || 0}} files)</small></span></div></h4></uib-accordion-heading><ul class=list-group style=margin-bottom:0px><li class="list-group-item truncate" ng-repeat="file in pfiltered = ( playlist.assets | filter:label_search | filter:extension)" ng-class={&quot;list-group-item-danger&quot;:file.deleted} ng-click=loadAsset(file)><div class=media><div class=media-body><div class=row><div class=col-sm-8 ng-click=loadAsset(file)><a ng-href=#><video ng-src="media/{{file}}"></video> <h4>{{file.filename || file}}</h4></a></div><div class=col-sm-4><div class="btn-toolbar pull-right"><button class="btn btn-primary-outline btn-xs" title="{{\'Add validity period for the asset\' | translate}}" ng-if=adminServer ng-click=scheduleValidity(file)><i class="fa fa-calendar">&nbsp;</i><small ng-if="!(filesDetails[file.filename || file].validity.enable)" translate=translate>add validity</small><small ng-if="filesDetails[file.filename || file].validity.enable"><small>{{filesDetails[file.filename || file].validity.startdate | date:\'MMM d\':\'UTC\'}}</small><small class=text-muted ng-if="filesDetails[file.filename || file].validity.startdate &amp;&amp; filesDetails[file.filename || file].validity.starthour">({{filesDetails[file.filename || file].validity.starthour}}h)</small><small>-</small><small>{{filesDetails[file.filename || file].validity.enddate | date:\'MMM d\':\'UTC\'}}</small><small class=text-muted ng-if="filesDetails[file.filename || file].validity.enddate &amp;&amp; filesDetails[file.filename || file].validity.endhour">({{filesDetails[file.filename || file].validity.endhour}}h)</small></small></button> <button class="btn btn-primary-outline btn-xs" title="{{\'Add or Remove this asset from multiple playlists\' | translate}}" ng-if=adminServer ng-click=assignAsset(file)><small translate=translate>Assign playlists</small></button> <button class="btn btn-default btn-xs" ng-if=!adminServer ng-click=playAsset(file)><small translate=translate>Play</small></button> <button class="btn btn-xs btn-link" ng-attr-title="{{\'delete\' | translate}}" ng-click=delete(file)><i class="fa fa-trash text-danger"></i></button> <button class="btn btn-xs btn-link" ng-hide=disableDownload title="{{\'Download asset\'| translate}}" ng-click=download(file,$index)><i class="fa fa-download"></i></button> <button class="btn btn-xs btn-outline-secondary pl-10"><input type=checkbox id=file name=checkbox ng-model=filtered.selected[file]></button></div></div></div><div class=row ng-if="filesDetails[file.filename || file]"><div class=col-sm-7><small>{{filesDetails[file.filename || file].type}}</small><small class=pl-10 ng-if="filesDetails[file.filename || file].duration &gt; 0"><span>{{filesDetails[file.filename || file].duration}}</span><span class=text-muted translate=translate>&nbsp;seconds</span></small><small class=pl-10 ng-if="filesDetails[file.filename || file].resolution.width"><span>{{filesDetails[file.filename || file].resolution.width}}x{{filesDetails[file.filename || file].resolution.height}}</span></small><small class=pl-10>{{filesDetails[file.filename || file].size}}</small><small class="text-muted pl-5" translate=translate>uploaded on:</small><small>{{filesDetails[file.filename || file].createdAt | date: \'MMM dd,yy\'}}</small><small class="text-muted pl-5" translate=translate>by:</small><small>{{filesDetails[file.filename || file].createdBy.name}}</small></div><div class=col-sm-5><p class=truncate><small class=text-muted translate=translate>Categories:&nbsp;</small><small>{{filesDetails[file.filename || file].labels.toString() || "None"}}</small></p></div></div></div><div class=row><div class=col-sm-12><small translate=translate><small class=text-muted>Playlists:&nbsp;</small><small style="word-wrap: break-word;" ng-repeat="pl in filesDetails[file.filename || file].playlists track by $index"><a href=/playlists/details/{{pl}}>{{pl}}&nbsp;</a></small></small></div></div><div class=row ng-show="filesDetails[file.filename || file].groupIds.length"><div class=col-sm-12><small class=text-muted translate=translate>Groups:&nbsp;</small><small style="white-space:normal;word-wrap: break-word;">{{filesDetails[file.filename || file].groupNames}}</small></div></div></div></li></ul><h5 class=text-warning ng-if=!pfiltered.length translate=translate>No Files</h5></div><div is-open=true uib-accordion-group=uib-accordion-group><uib-accordion-heading><h4 class="row text-primary" ng-click="status.unassignedView = !status.unassignedView"><small class="col-sm-1 text-success"><b><i class="fa fa-lg" ng-class="{\'fa-caret-down\':status.unassignedView,\'fa-caret-right\':!status.unassignedView}">&nbsp;</i></b></small><div class="text-primary col-sm-5"><span translate=translate>Un-assigned</span><span>&nbsp;</span><span><small>({{ufiltered.length || 0}}</small><small translate=translate>files)</small></span></div></h4></uib-accordion-heading><ul class=list-group style=margin-bottom:0px><li class="list-group-item truncate" ng-repeat="file in ufiltered = (unassigned | filter:label_search | filter:extension)" ng-class={&quot;list-group-item-danger&quot;:file.deleted} ng-click=loadAsset(file)><div class=media><div class=media-left><a ng-href=# ng-click=loadAsset(file) ng-if="filesDetails[file.filename || file].thumbnail"><img class="media-object img-rounded letter-box lazy-load" data-src="{{filesDetails[file.filename || file].thumbnail}}"></a><a class="letter-box media-object img-rounded" ng-href=# ng-click=loadAsset(file) ng-if="!filesDetails[file.filename || file].thumbnail"><span class=media-object ng-if="filesDetails[file.filename || file].type == &quot;audio&quot; || filesDetails[file.filename || file].type == &quot;radio&quot;"><i class="fa fa-music"></i></span><span class=media-object ng-if="filesDetails[file.filename || file].type != &quot;audio&quot; &amp;&amp; filesDetails[file.filename || file].type != &quot;radio&quot;">{{filesDetails[file].type.slice(0,1) || \'N\'}}</span></a></div><div class=media-body><div class=row><div class=col-sm-8 ng-click=loadAsset(file)><a ng-href=#><h4>{{file.filename || file}}</h4></a></div><div class=col-sm-4><div class="btn-toolbar pull-right"><button class="btn btn-primary-outline btn-xs" title="{{\'Add validity period for the asset\' | translate}}" ng-if=adminServer ng-click=scheduleValidity(file)><i class="fa fa-calendar">&nbsp;</i><small ng-if="!(filesDetails[file.filename || file].validity.enable)" translate=translate>add validity</small><small ng-if="filesDetails[file.filename || file].validity.enable"><small>{{filesDetails[file.filename || file].validity.startdate | date:\'MMM d\':\'UTC\'}}</small><small class=text-muted ng-if="filesDetails[file.filename || file].validity.startdate &amp;&amp; filesDetails[file.filename || file].validity.starthour">({{filesDetails[file.filename || file].validity.starthour}}h)</small><small>-</small><small>{{filesDetails[file.filename || file].validity.enddate | date:\'MMM d\':\'UTC\'}}</small><small class=text-muted ng-if="filesDetails[file.filename || file].validity.enddate &amp;&amp; filesDetails[file.filename || file].validity.endhour">({{filesDetails[file.filename || file].validity.endhour}}h)</small></small></button> <button class="btn btn-primary-outline btn-xs" title="{{\'Add or Remove this asset from multiple playlists\' | translate}}" ng-if=adminServer ng-click=assignAsset(file)><small translate=translate>Assign playlists</small></button> <button class="btn btn-default btn-xs" ng-if=!adminServer ng-click=playAsset(file)><small translate=translate>Play</small></button> <button class="btn btn-xs btn-link" ng-attr-title="{{\'delete\' | translate}}" ng-click=delete(file)><i class="fa fa-trash text-danger"></i></button> <button class="btn btn-xs btn-link" ng-hide=disableDownload title="{{\'Download asset\'| translate}}" ng-click=download(file,$index)><i class="fa fa-download"></i></button> <button class="btn btn-xs btn-outline-secondary pl-10"><input type=checkbox id=file name=checkbox ng-model=filtered.selected[file]></button></div></div></div><div class=row ng-if="filesDetails[file.filename || file]"><div class=col-sm-7><small>{{filesDetails[file.filename || file].type}}</small><small class=pl-10 ng-if="filesDetails[file.filename || file].duration &gt; 0"><span>{{filesDetails[file.filename || file].duration}}</span><span class=text-muted translate=translate>&nbsp;seconds</span></small><small class=pl-10 ng-if="filesDetails[file.filename || file].resolution.width"><span>{{filesDetails[file.filename || file].resolution.width}}x{{filesDetails[file.filename || file].resolution.height}}</span></small><small class=pl-10>{{filesDetails[file.filename || file].size}}</small><small class="text-muted pl-5" translate=translate>uploaded on:</small><small>{{filesDetails[file.filename || file].createdAt | date: \'MMM dd,yy\'}}</small><small class="text-muted pl-5" translate=translate>by:</small><small>{{filesDetails[file.filename || file].createdBy.name}}</small></div><div class=col-sm-5><p class=truncate><small class=text-muted translate=translate>Categories:&nbsp;</small><small>{{filesDetails[file.filename || file].labels.toString() || "None"}}</small></p></div></div></div><div class=row><div class=col-sm-12><small translate=translate><small class=text-muted>Playlists:&nbsp;</small><small style="word-wrap: break-word;" ng-repeat="pl in filesDetails[file.filename || file].playlists track by $index"><a href=/playlists/details/{{pl}}>{{pl}}&nbsp;</a></small></small></div></div><div class=row ng-show="filesDetails[file.filename || file].groupIds.length"><div class=col-sm-12><small class=text-muted translate=translate>Groups:&nbsp;</small><small style="white-space:normal;word-wrap: break-word;">{{filesDetails[file.filename || file].groupNames}}</small></div></div></div></li></ul><h5 class=text-warning ng-if=!ufiltered.length translate=translate>No Files</h5></div></uib-accordion></div></div><div class="alert alert-warning" ng-hide="collaborator.rights.asset.create == true"><h4 translate=translate>You do not have access to this screen</h4></div>'
        ),
        e.put(
          "/app/partials/welcome/_welcome.html",
          '<div class="top-item"><div class="row"><div class="col-sm-12"><div class="play-header"><h2><span>IKEA</span> Design Through The Year</h2></div></div></div></div><div class="item"><div class="holder" ng-repeat="file in filteredFiles.items = (files)"><div class="row"><div class="col-sm-6"><div class="vid-cont"><video id="vid"  width="100%" height="100%"><source src="media/{{file}}"></source></video></video><a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset(file)><div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div></a></div></div><div class="col-sm-6"><div class="item-desc"><div class="item-year"> <span>1914</span><h3 class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <p id="p2">Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p></div><div class="rd-more"><a href="#">Read More</a></div></div></div></div></div></div>'
        ), 
        e.put(
          "/app/partials/catagories/_catagories.html",
          '<div class="" ng-show="collaborator.rights.asset.create == true" drop-area=drop-area onstart=upload.started() onprogress=upload.progress(percentDone) onerror="upload.error(files, type, msg)" ondone="upload.done(files, data)" drag-status=dragStatus link-fn=linksPopUp() link-value=urlLink ng-class={dim:dragStatus.inProgress}> <div class="alert drop-notification" ng-show=dragStatus.inProgress> <h4><i class="fa fa-cloud-upload">&nbsp;</i><span translate=translate>Drop the</span><span>&nbsp;{{ dragStatus.transferItem }}&nbsp;</span><span translate=translate>to upload</span> </h4> </div> <div class="panel-heading top-panel"> <div class=row> <div class=col-sm-12><img class="img-responsive" src="app/img/main-banner.png"></div> </div> </div></div><div class="cata-container"><div class="panel-heading"> <div class="row"> <div class="col-sm-3"> <div class="file-item text-center card-item"> <a href="/cat-a"><img src="/app/c-img/c1.png" alt="" class="img-responsive"></a> <div class="glow"></div> </div> </div> <div class="col-sm-3"> <div class="file-item text-center card-item"> <a href="/cat-a"><img src="/app/c-img/c2.png" alt="" class="img-responsive"></a> <div class="glow"></div> </div> </div> <div class="col-sm-3"> <div class="file-item text-center card-item"> <a href="/cat-a"><img src="/app/c-img/c3.png" alt="" class="img-responsive"></a> <div class="glow"></div> </div> </div> <div class="col-sm-3"> <div class="file-item text-center card-item"> <a href="/cat-a"><img src="/app/c-img/c4.png" alt="" class="img-responsive"></a> <div class="glow"></div> </div> </div> <div class="col-sm-3"> <div class="file-item text-center card-item"> <a href="/cat-a"><img src="/app/c-img/c5.png" alt="" class="img-responsive"></a> <div class="glow"></div> </div> </div> <div class="col-sm-3"> <div class="file-item text-center card-item"> <a href="/cat-a"><img src="/app/c-img/c6.png" alt="" class="img-responsive"></a> <div class="glow"></div> </div> </div> <div class="col-sm-3"> <div class="file-item text-center card-item"> <a href="/cat-a"><img src="/app/c-img/c7.png" alt="" class="img-responsive"></a> <div class="glow"></div> </div> </div> <div class="col-sm-3"> <div class="file-item text-center card-item"> <a href="/cat-a"><img src="/app/c-img/c8.png" alt="" class="img-responsive"></a> <div class="glow"></div> </div> </div> </div></div>'
        ),
        e.put(
          "/app/partials/cat-a/_cat-a.html",
          '<div class="top-item"> <div class="row"> <div class="col-sm-12"> <div class="play-header"> <h2><span>IKEA</span> Design Through The Year</h2> </div> </div> </div></div><div class="item-1"><div class="holder-1"><div class="row"> <div class="col-sm-6"> <div id="slider"> <figure><img src="app/cat-img/ca1.png" alt= class="img-responsive" width="100%" height="100%"><img src="/app/cat-img/ca2.png" alt= class="img-responsive" width="100%" height="100%"><img src="/app/cat-img/ca3.png" alt="" width="100%" height="100%"><img src="/app/cat-img/ca4.png" alt="" width="100%" height="100%"></figure> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1914</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3> Three-seat sofas </h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="prd-info"> <div class="row"> <div class="col-sm-12"> <div class="prd-head"> <div class="name"> <span>Funiture</span> <h4>Two-seat sofas</h4> </div> <div class="type"><span>Size</span></div> <div class="row"> <div class="col-sm-4"> <div class="width"> <h4>Width</h4> <ul> <li>120 - 139 cm</li> </ul> </div> </div> <div class="col-sm-4"> <div class="height"> <h4>Height</h4> <ul> <li>65 - 69 cm</li> </ul> </div> </div> <div class="col-sm-4"> <div class="depth"> <h4>Depth</h4> <ul> <li>70 - 79 cm</li> </ul> </div> </div> </div> </div> <div class="prd-color"> <div class="row"> <div class="col-sm-4"> <h4><span>Availble colors</span></h4> <ul> <li><span style="background: red"></span></li> <li><span style="background: black"></span></li> <li><span style="background: gray"></span></li> <li><span style="background: Blue"></span></li> </ul> </div> <div class="col-sm-4"> <div class="opt-details"> <div class="p-price"> <p>Rs.<span>2,490/-</span></p> </div> </div> </div> <div class="col-sm-4"> <div class="price-btn"><button class="button button--janus" ng-if=!adminServer ng-click=playAsset("a.mp4")><span>Click Here</span></button></div> </div> </div> </div> </div> </div> </div> </div> </div></div><div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div id="slider"> <figure><img src="app/cat-img/cb1.png" alt= class="img-responsive" width="100%" height="100%"><img src="/app/cat-img/cb2.png" alt= class="img-responsive" width="100%" height="100%"><img src="/app/cat-img/cb3.png" alt="" width="100%" height="100%"><img src="/app/cat-img/cb4.png" alt="" width="100%" height="100%"></figure> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1915</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Two Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="prd-info"> <div class="row"> <div class="col-sm-12"> <div class="prd-head"> <div class="name"> <span>Funiture</span> <h4>Two-seat sofas</h4> </div> <div class="type"><span>Size</span></div> <div class="row"> <div class="col-sm-4"> <div class="width"> <h4>Width</h4> <ul> <li>120 - 139 cm</li> </ul> </div> </div> <div class="col-sm-4"> <div class="height"> <h4>Height</h4> <ul> <li>65 - 69 cm</li> </ul> </div> </div> <div class="col-sm-4"> <div class="depth"> <h4>Depth</h4> <ul> <li>70 - 79 cm</li> </ul> </div> </div> </div> </div> <div class="prd-color"> <div class="row"> <div class="col-sm-4"> <h4><span>Availble colors</span></h4> <ul> <li><span style="background: red"></span></li> <li><span style="background: black"></span></li> <li><span style="background: gray"></span></li> <li><span style="background: Blue"></span></li> </ul> </div> <div class="col-sm-4"> <div class="opt-details"> <div class="p-price"> <p>Rs.<span>2,490/-</span></p> </div> </div> </div> <div class="col-sm-4"> <div class="price-btn"><button class="button button--janus" ng-if=!adminServer ng-click=playAsset("b.mp4")><span>Click Here</span></button></div> </div> </div> </div> </div> </div> </div> </div> </div> </div></div><div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div id="slider"> <figure><img src="app/cat-img/cc1.png" alt= class="img-responsive" width="100%" height="100%"><img src="/app/cat-img/cc2.png" alt= class="img-responsive" width="100%" height="100%"><img src="/app/cat-img/cc3.png" alt="" width="100%" height="100%"><img src="/app/cat-img/cc4.png" alt="" width="100%" height="100%"></figure> </div> </div> <div class="col-sm-6"> <div class="item-desc"> <div class="item-year-1"> <span>1916</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Three Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="prd-info"> <div class="row"> <div class="col-sm-12"> <div class="prd-head"> <div class="name"> <span>Funiture</span> <h4>Two-seat sofas</h4> </div> <div class="type"><span>Size</span></div> <div class="row"> <div class="col-sm-4"> <div class="width"> <h4>Width</h4> <ul> <li>120 - 139 cm</li> </ul> </div> </div> <div class="col-sm-4"> <div class="height"> <h4>Height</h4> <ul> <li>65 - 69 cm</li> </ul> </div> </div> <div class="col-sm-4"> <div class="depth"> <h4>Depth</h4> <ul> <li>70 - 79 cm</li> </ul> </div> </div> </div> </div> <div class="prd-color"> <div class="row"> <div class="col-sm-4"> <h4><span>Availble colors</span></h4> <ul> <li><span style="background: red"></span></li> <li><span style="background: black"></span></li> <li><span style="background: gray"></span></li> <li><span style="background: Blue"></span></li> </ul> </div> <div class="col-sm-4"> <div class="opt-details"> <div class="p-price"> <p>Rs.<span>2,490/-</span></p> </div> </div> </div> <div class="col-sm-4"> <div class="price-btn"><button class="button button--janus" ng-if=!adminServer ng-click=playAsset("c.mp4")><span>Click Here</span></button></div> </div> </div> </div> </div> </div> </div> </div> </div> </div></div><div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div id="slider"> <figure><img src="app/cat-img/cd1.png" alt= class="img-responsive" width="100%" height="100%"><img src="/app/cat-img/cd2.png" alt= class="img-responsive" width="100%" height="100%"><img src="/app/cat-img/cd3.png" alt="" width="100%" height="100%"><img src="/app/cat-img/cd4.png" alt="" width="100%" height="100%"></figure> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1917</span> <h3 class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Four Goes Here</h3> <p id="p2">Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="prd-info"> <div class="row"> <div class="col-sm-12"> <div class="prd-head"> <div class="name"> <span>Funiture</span> <h4>Two-seat sofas</h4> </div> <div class="type"><span>Size</span></div> <div class="row"> <div class="col-sm-4"> <div class="width"> <h4>Width</h4> <ul> <li>120 - 139 cm</li> </ul> </div> </div> <div class="col-sm-4"> <div class="height"> <h4>Height</h4> <ul> <li>65 - 69 cm</li> </ul> </div> </div> <div class="col-sm-4"> <div class="depth"> <h4>Depth</h4> <ul> <li>70 - 79 cm</li> </ul> </div> </div> </div> </div> <div class="prd-color"> <div class="row"> <div class="col-sm-4"> <h4><span>Availble colors</span></h4> <ul> <li><span style="background: red"></span></li> <li><span style="background: black"></span></li> <li><span style="background: gray"></span></li> <li><span style="background: Blue"></span></li> </ul> </div> <div class="col-sm-4"> <div class="opt-details"> <div class="p-price"> <p>Rs.<span>2,490/-</span></p> </div> </div> </div> <div class="col-sm-4"> <div class="price-btn"><button class="button button--janus" ng-if=!adminServer ng-click=playAsset("d.mp4")><span>Click Here</span></button></div> </div> </div> </div> </div> </div> </div> </div> </div> </div></div><div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div id="slider"> <figure><img src="app/cat-img/ca1.png" alt= class="img-responsive" width="100%" height="100%"><img src="/app/cat-img/ca2.png" alt= class="img-responsive" width="100%" height="100%"><img src="/app/cat-img/ca3.png" alt="" width="100%" height="100%"><img src="/app/cat-img/ca4.png" alt="" width="100%" height="100%"></figure> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1918</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Five Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="prd-info"> <div class="row"> <div class="col-sm-12"> <div class="prd-head"> <div class="name"> <span>Funiture</span> <h4>Two-seat sofas</h4> </div> <div class="type"><span>Size</span></div> <div class="row"> <div class="col-sm-4"> <div class="width"> <h4>Width</h4> <ul> <li>120 - 139 cm</li> </ul> </div> </div> <div class="col-sm-4"> <div class="height"> <h4>Height</h4> <ul> <li>65 - 69 cm</li> </ul> </div> </div> <div class="col-sm-4"> <div class="depth"> <h4>Depth</h4> <ul> <li>70 - 79 cm</li> </ul> </div> </div> </div> </div> <div class="prd-color"> <div class="row"> <div class="col-sm-4"> <h4><span>Availble colors</span></h4> <ul> <li><span style="background: red"></span></li> <li><span style="background: black"></span></li> <li><span style="background: gray"></span></li> <li><span style="background: Blue"></span></li> </ul> </div> <div class="col-sm-4"> <div class="opt-details"> <div class="p-price"> <p>Rs.<span>2,490/-</span></p> </div> </div> </div> <div class="col-sm-4"> <div class="price-btn"><button class="button button--janus" ng-if=!adminServer ng-click=playAsset("e.mp4")><span>Click Here</span></button></div> </div> </div> </div> </div> </div> </div> </div> </div> </div></div><div class="return-home"> <a href="/catagories" class="float btn-challenge" title="Back to home"><span>Home</span></a></div>'
        ), 
        e.put(
          "/app/partials/cat-b/_cat-b.html",
          '<div class="top-item"> <div class="row"> <div class="col-sm-12"> <div class="play-header"> <h2><span>IKEA</span> Design Through The Year</h2> </div> </div> </div></div><div class="item-1"> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/a.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("a.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1914</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3> Three-seat sofas </h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/b.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("b.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1915</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Two Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/c.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("c.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc"> <div class="item-year-1"> <span>1916</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Three Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/d.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("d.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1917</span> <h3 class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Four Goes Here</h3> <p id="p2">Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/e.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("e.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1918</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Five Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div><!-- </div> --><div class="return-home"><a href="/catagories" class="float" title="Back to home"><i class="fa fa-home my-float"></i></a></div>'
        ),
        e.put(
          "/app/partials/cat-c/_cat-c.html",
          '<div class="top-item"> <div class="row"> <div class="col-sm-12"> <div class="play-header"> <h2><span>IKEA</span> Design Through The Year</h2> </div> </div> </div></div><div class="item-1"> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/a.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("a.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1914</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3> Three-seat sofas </h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/b.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("b.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1915</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Two Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/c.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("c.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc"> <div class="item-year-1"> <span>1916</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Three Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/d.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("d.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1917</span> <h3 class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Four Goes Here</h3> <p id="p2">Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/e.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("e.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1918</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Five Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div><!-- </div> --><div class="return-home"><a href="/catagories" class="float" title="Back to home"><i class="fa fa-home my-float"></i></a></div>'
        ), 
        e.put(
          "/app/partials/cat-c/_cat-d.html",
          '<div class="top-item"> <div class="row"> <div class="col-sm-12"> <div class="play-header"> <h2><span>IKEA</span> Design Through The Year</h2> </div> </div> </div></div><div class="item-1"> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/a.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("a.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1914</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3> Three-seat sofas </h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/b.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("b.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1915</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Two Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/c.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("c.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc"> <div class="item-year-1"> <span>1916</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Three Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/d.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("d.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1917</span> <h3 class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Four Goes Here</h3> <p id="p2">Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/e.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("e.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1918</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Five Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div><!-- </div> --><div class="return-home"><a href="/catagories" class="float" title="Back to home"><i class="fa fa-home my-float"></i></a></div>'
        ),   
        e.put(
          "/app/partials/cat-e/_cat-e.html",
          '<div class="top-item"> <div class="row"> <div class="col-sm-12"> <div class="play-header"> <h2><span>IKEA</span> Design Through The Year</h2> </div> </div> </div></div><div class="item-1"> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/a.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("a.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1914</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title One Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/b.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("b.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1915</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Two Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/c.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("c.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc"> <div class="item-year-1"> <span>1916</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Three Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/d.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("d.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1917</span> <h3 class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Four Goes Here</h3> <p id="p2">Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/e.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("e.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1918</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Five Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div><!-- </div> --><div class="return-home"><a href="/catagories" class="float" title="Back to home"><i class="fa fa-home my-float"></i></a></div>'
        ),
        e.put(
          "/app/partials/cat-e/_cat-f.html",
          '<div class="top-item"> <div class="row"> <div class="col-sm-12"> <div class="play-header"> <h2><span>IKEA</span> Design Through The Year</h2> </div> </div> </div></div><div class="item-1"> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/a.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("a.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1914</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title One Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/b.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("b.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1915</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Two Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/c.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("c.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc"> <div class="item-year-1"> <span>1916</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Three Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/d.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("d.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1917</span> <h3 class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Four Goes Here</h3> <p id="p2">Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/e.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("e.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1918</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Five Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div><!-- </div> --><div class="return-home"><a href="/catagories" class="float" title="Back to home"><i class="fa fa-home my-float"></i></a></div>'
        ),  
        e.put(
          "/app/partials/cat-e/_cat-g.html",
          '<div class="top-item"> <div class="row"> <div class="col-sm-12"> <div class="play-header"> <h2><span>IKEA</span> Design Through The Year</h2> </div> </div> </div></div><div class="item-1"> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/a.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("a.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1914</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title One Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/b.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("b.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1915</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Two Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/c.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("c.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc"> <div class="item-year-1"> <span>1916</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Three Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/d.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("d.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1917</span> <h3 class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Four Goes Here</h3> <p id="p2">Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/e.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("e.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1918</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Five Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div><!-- </div> --><div class="return-home"><a href="/catagories" class="float" title="Back to home"><i class="fa fa-home my-float"></i></a></div>'
        ),  
        e.put(
          "/app/partials/cat-h/_cat-h.html",
          '<div class="top-item"> <div class="row"> <div class="col-sm-12"> <div class="play-header"> <h2><span>IKEA</span> Design Through The Year</h2> </div> </div> </div></div><div class="item-1"> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/a.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("a.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1914</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title One Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/b.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("b.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1915</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Two Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/c.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("c.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc"> <div class="item-year-1"> <span>1916</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Three Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/d.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("d.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1917</span> <h3 class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Four Goes Here</h3> <p id="p2">Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div> <div class="holder-1"> <div class="row"> <div class="col-sm-6"> <div class="vid-cont"> <video id="vid" width="100%" height="100%"> <source src="media/e.mp4"> </source> </video> </video> <a class="btn btn-default btn-xs click-btn" ng-if=!adminServer ng-click=playAsset("e.mp4")> <div translate=translate><img src="app/img/img-btn.png" width="85px" height="85px" alt="" class="img-responsive"></div> </a> </div> </div> <div class="col-sm-6"> <div class="item-desc-1"> <div class="item-year-1"> <span>1918</span> <h3 class="date-1"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>June 18</h3> <h3>Title Five Goes Here</h3> <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy. </p> </div> <div class="rd-more-1"><a href="#">Read More</a></div> </div> </div> </div> </div><!-- </div> --><div class="return-home"><a href="/catagories" class="float" title="Back to home"><i class="fa fa-home my-float"></i></a></div>'
        ), 
        e.put(
