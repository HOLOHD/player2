    ...
    function (e) {
      ...
      e.put(
        ...
        e.put(
          ...
          '<div class="panel panel-default custom-panel" ng-show="collaborator.rights.asset.create == true" drop-area=drop-area onstart=upload.started() onprogress=upload.progress(percentDone) onerror="upload.error(files, type, msg)" ondone="upload.done(files, data)" drag-status=dragStatus link-fn=linksPopUp() link-value=urlLink ng-class={dim:dragStatus.inProgress}> <div class="alert drop-notification" ng-show=dragStatus.inProgress> <h4><i class="fa fa-cloud-upload">&nbsp;</i><span translate=translate>Drop the</span><span>&nbsp;{{ dragStatus.transferItem }}&nbsp;</span><span translate=translate>to upload</span> </h4> </div> <div class="panel-heading top-panel"> <div class=row> <div class=col-sm-12><img class="img-responsive" src="app/img/main-banner.png"></div> </div> </div></div><div class="cata-container"><div class="panel-heading"> <div class="row"> <div class="col-sm-3"> <div class="file-item text-center"><a href="/cat-a"><img src="https://static.vecteezy.com/system/resources/previews/005/307/741/non_2x/database-document-icon-free-vector.jpg" alt="" class="img-responsive"><span>Furnitures</span></a></div> </div> <div class="col-sm-3"> <div class="file-item text-center"><a href="/cat-b"><img src="https://static.vecteezy.com/system/resources/previews/005/307/741/non_2x/database-document-icon-free-vector.jpg" alt="" class="img-responsive"><span>Home Textiles</span></a></div> </div> <div class="col-sm-3"> <div class="file-item text-center"><a href="/cat-c" ><img src="https://static.vecteezy.com/system/resources/previews/005/307/741/non_2x/database-document-icon-free-vector.jpg" alt="" class="img-responsive"><span>Decoration</span></a></div> </div> <div class="col-sm-3"> <div class="file-item text-center"><a href="/cat-d"><img src="https://static.vecteezy.com/system/resources/previews/005/307/741/non_2x/database-document-icon-free-vector.jpg" alt="" class="img-responsive"><span>Lighting</span></a></div> </div> <div class="col-sm-3"> <div class="file-item text-center"><a href="/cat-e"><img src="https://static.vecteezy.com/system/resources/previews/005/307/741/non_2x/database-document-icon-free-vector.jpg" alt="" class="img-responsive"><span>Kitchen & appliances</span></a></div> </div> <div class="col-sm-3"> <div class="file-item text-center"><a href="/cat-f"><img src="https://static.vecteezy.com/system/resources/previews/005/307/741/non_2x/database-document-icon-free-vector.jpg" alt="" class="img-responsive"><span>Smart Home</span></a></div> </div> <div class="col-sm-3"> <div class="file-item text-center"><a href="/cat-g"><img src="https://static.vecteezy.com/system/resources/previews/005/307/741/non_2x/database-document-icon-free-vector.jpg" alt="" class="img-responsive"><span>Beds & mattresses</span></a></div> </div> <div class="col-sm-3"> <div class="file-item text-center"><a href="/cat-h"><img src="https://static.vecteezy.com/system/resources/previews/005/307/741/non_2x/database-document-icon-free-vector.jpg" alt="" class="img-responsive"><span>Baby & children</span></a></div> </div> </div></div>'
        ),
        e.put(
