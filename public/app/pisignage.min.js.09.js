          ...
          (o.openLayout = function () {
            ...
            (o.layouts = [
              ...
              },
              {
                ...
                description: g(
                  "main Zone:960x540, side Zone:320x540, bottom Zone:1280x180"
                ),
              },
              {
                type: "3b",
              ...
              },
              {
                type: "3c",
                title: g(
                  "Three Zones(full top) with Main Zone on right (enable in settings)"
                ),
                description: g(
                  "main Zone:960x540, side Zone:320x540, top Zone:1280x180"
                ),
              },
              {
                type: "3d",
                title: g(
                  "Three Zones(full top) with Main Zone on left (enable in settings)"
                ),
                description: g(
                  "main Zone:960x540, side Zone:320x540, top Zone:1280x180"
                ),
              },
              {
                ...
                description: g(
                  "main Zone:960x540, side Zone:320x720, bottom Zone:960x180"
                ),
              },
              {
                type: "4b",
              ...
              },
              {
                type: "4c",
                title: g(
                  "Three Zones(full side) with Main Zone on right (enable in settings)"
                ),
                description: g(
                  "main Zone:960x540, side Zone:320x720, top Zone:960x180"
                ),
              },
              {
                type: "4d",
                title: g(
                  "Three Zones(full side) with Main Zone on left (enable in settings)"
                ),
                description: g(
                  "main Zone:960x540, side Zone:320x720, top Zone:960x180"
                ),
