...
angular.module("piConfig", []).constant("piUrls", function () {
    ...
    "use strict";
    e.put("/app/partials/home/_pihome.html", '<div class="well well-sm"><div class="row"><div class="col-sm-12"><div class="top-banner"><img class="img-responsive" alt="" src="app/img/home-banner.jpg"/></div></div></div></div><div class="well well-sm" ng-if="!playlistOn &amp;&amp; !operationInProgress" uib-dropdown=uib-dropdown><button class="btn btn-success btn-block" style="background: #192233 !important;" uib-dropdown-toggle=uib-dropdown-toggle><span translate=translate>No Playlist is being played</span><br><span translate=translate>START PLAYING &nbsp;</span><span class=caret></span></button><ul class="dropdown-menu pull-right" role=menu uib-dropdown-menu=uib-dropdown-menu><li class=text-danger ng-repeat="item in playlistsNames"><a ng-href=# ng-click=play(item)><h4>{{item}}</h4></a></li></ul></div><div class="well well-sm" ng-if="playlistOn &amp;&amp; !operationInProgress"><div class=row><div class=col-xs-3><button class="btn btn-block" ng-class="{\'btn-danger\': !tvStatus , \'btn-success\': tvStatus }"><small translate=translate>PRODUCT</small></button></div><div class=col-xs-6><h5><span translate=translate>Playlist</span><span>:&nbsp; {{currentPlaylist}} ({{currentPlayingFile}})</span></h5><h6 ng-if=duration><span translate=translate>Playing since:</span><span>&nbsp;{{duration | date:\'medium\'}}</span></h6></div><div class=col-xs-3><button class="btn btn-danger btn-block" ng-click=stop() translate=translate>STOP</button></div></div><div class=row><div class="col-xs-6 col-xs-offset-3 text-center"><button class="btn btn-sm btn-primary-outline" title="click to step backward" ng-click="playlistMedia(\'backward\')"><i class="fa fa-step-backward fa-lg"></i></button> <button class="btn btn-sm btn-primary-outline" title="click to pause/resume play" ng-click="playlistMedia(\'pause\')"><i class="fa fa-lg" ng-class="pausePlayButtonPaused?\'fa-play\':\'fa-pause\'"></i></button> <button class="btn-sm btn btn-primary-outline" title="click to step forward" ng-click="playlistMedia(\'forward\')"><i class="fa fa-step-forward fa-lg"></i></button></div></div></div><div class="well well-sm" ng-if=operationInProgress><button class="btn btn-warning btn-block"><span translate=translate>Please Wait, Request pending</span></button></div><div class="well well-sm"><div class=row><div class=col-xs-8><small class=text-muted translate=translate>Storage:</small>{{diskSpaceAvailable}}<span translate=translate>&nbsp;free</span></div><div class=col-xs-4><div class=progress><div class="progress-bar progress-bar-warning-cs" role=progressbar aria-valuenow=0 aria-valuemin=0 aria-valuemax=100 style="width: {{diskSpaceUsed}}; color:#a7a8ab" ><span>{{diskSpaceUsed}}</span><span translate=translate>used</span></div></div></div></div></div><div class="well well-sm"><div class="row"><div class="col-sm-8"> <div class="row"> <div class="col-xs-4 col-padding-5px"><a class="btn btn-link btn-block" href="/playlists" style="color:#0e121d"><i class="fa fa-list-alt fa-3x"></i><p style="font-size:12px" translate="translate">Playlists</p></a></div><div class="col-xs-4 col-padding-5px"><a class="btn btn-link btn-block" href="/assets" style="color:#0e121d"><i class="fa fa-folder-open fa-3x"></i><p style="font-size:12px" translate="translate">Assets</p></a></div><div class="col-xs-4 col-padding-5px"><a class="btn btn-link btn-block" href="/settings" style="color:#0e121d"><i class="fa fa-cog fa-3x"></i><p style="font-size:12px" translate="translate">Settings</p></a></div></div></div><div class="col-sm-4"> <div class="row"> <div class="col-sm-6"> <a class="btn btn-link btn-block" href="#" style="color:#0e121d"><i class="fa fa-refresh fa-3x"></i><p style="font-size:12px" translate="translate">Restart</p></a> </div><div class="col-sm-6"> <a class="btn btn-link btn-block" href="#" style="color:#0e121d"><i class="fa fa-power-off fa-3x" aria-hidden="true"></i><p style="font-size:12px" translate="translate">Shutdown</p></a> </div></div></div></div></div><div class="well well-sm"><div class=row><div class=col-sm-6><div uib-dropdown=uib-dropdown><span class=text-muted>Select debug level</span> <button class="btn btn-sm btn-link home-btn" uib-dropdown-toggle=uib-dropdown-toggle>{{currentDebugLevel}}<i class="fa fa-caret-down"></i></button><ul class=dropdown-menu role=menu uib-dropdown-menu=uib-dropdown-menu><li ng-repeat="level in debugLevels"><a href=# ng-click=selectDebugLevel(level)>&nbsp;&nbsp;{{level}}</a></li></ul></div><h5>Download the log files</h5><div class=btn-group-vertical><button class="btn btn-link btn-xs home-btn" type=button ng-click="downloadLog(\'forever_out.log\')"><h6>Main Log (forever_out.log)</h6></button> <button class="btn btn-link btn-xs home-btn" type=button ng-click="downloadLog(\'forever_err.log\')"><h6>Error Log (forever_err.log)</h6></button> <button class="btn btn-link btn-xs home-btn" type=button ng-click="downloadLog(\'forever.log\')"><h6>Upgrade Log (forever.log)</h6></button></div><h6 class=text-warning ng-bind=statusMessage>{{statusMessage }}</h6></div><div class=col-sm-6><div class=col-sm-10 ng-hide=modal><div style=text-align:right ng-if=!img64>Screenshot not available</div><img data-ng-src=data:image/png;base64,{{img64}} ng-if=img64 height=250px></div><div class="col-sm-2 pull-right"><div class=btn-group><button class="btn btn-primary btn-xs btn-cam" type=button ng-click=snapshot()><i class="fa fa-camera fa-lg" aria-hidden=true></i></button> <button class="btn btn-default btn-xs" ng-click=shellPopup()><i class="fa fa-lg fa-terminal"></i></button></div></div></div></div></div>'),
